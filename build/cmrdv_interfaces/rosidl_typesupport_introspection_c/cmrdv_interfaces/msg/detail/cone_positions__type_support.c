...
#include <stddef.h>
#include "cmrdv_interfaces/msg/detail/cone_positions__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  cmrdv_interfaces__msg__ConePositions__init(message_memory);
}

void ConePositions__rosidl_typesupport_introspection_c__ConePositions_fini_function(void * message_memory)
{
  cmrdv_interfaces__msg__ConePositions__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember ConePositions__rosidl_typesupport_introspection_c__ConePositions_message_member_array[2] = {
  {
    ...
    offsetof(cmrdv_interfaces__msg__ConePositions, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cmrdv_interfaces__msg__ConePositions, cone_positions),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers ConePositions__rosidl_typesupport_introspection_c__ConePositions_message_members = {
  ...
  2,  // number of fields
  sizeof(cmrdv_interfaces__msg__ConePositions),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cmrdv_interfaces, msg, ConePositions)() {
