...
{
  new (message_memory) cmrdv_interfaces::msg::ControlAction(_init);
}

void ControlAction_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cmrdv_interfaces::msg::ControlAction *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ControlAction_message_member_array[2] = {
  {
    ...
    offsetof(cmrdv_interfaces::msg::ControlAction, wheel_speed),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cmrdv_interfaces::msg::ControlAction, swangle),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ControlAction_message_members = {
  ...
  2,  // number of fields
  sizeof(cmrdv_interfaces::msg::ControlAction),
...
{
  return &::cmrdv_interfaces::msg::rosidl_typesupport_introspection_cpp::ControlAction_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cmrdv_interfaces, msg, ControlAction)() {
  return &::cmrdv_interfaces::msg::rosidl_typesupport_introspection_cpp::ControlAction_message_type_support_handle;
}
