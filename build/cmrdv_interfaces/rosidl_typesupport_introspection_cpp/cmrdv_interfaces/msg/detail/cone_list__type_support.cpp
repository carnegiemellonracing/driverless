...
{
  new (message_memory) cmrdv_interfaces::msg::ConeList(_init);
}

void ConeList_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cmrdv_interfaces::msg::ConeList *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ConeList_message_member_array[3] = {
  {
    ...
    offsetof(cmrdv_interfaces::msg::ConeList, blue_cones),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cmrdv_interfaces::msg::ConeList, yellow_cones),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cmrdv_interfaces::msg::ConeList, orange_cones),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ConeList_message_members = {
  ...
  3,  // number of fields
  sizeof(cmrdv_interfaces::msg::ConeList),
...
{
  return &::cmrdv_interfaces::msg::rosidl_typesupport_introspection_cpp::ConeList_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cmrdv_interfaces, msg, ConeList)() {
  return &::cmrdv_interfaces::msg::rosidl_typesupport_introspection_cpp::ConeList_message_type_support_handle;
}
