...
{
  new (message_memory) cmrdv_interfaces::msg::PairROT(_init);
}

void PairROT_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cmrdv_interfaces::msg::PairROT *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PairROT_message_member_array[3] = {
  {
    ...
    offsetof(cmrdv_interfaces::msg::PairROT, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<cmrdv_interfaces::msg::CarROT>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(cmrdv_interfaces::msg::PairROT, near),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cmrdv_interfaces::msg::PairROT, far),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers PairROT_message_members = {
  ...
  3,  // number of fields
  sizeof(cmrdv_interfaces::msg::PairROT),
...
get_message_type_support_handle<cmrdv_interfaces::msg::PairROT>()
{
  return &::cmrdv_interfaces::msg::rosidl_typesupport_introspection_cpp::PairROT_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cmrdv_interfaces, msg, PairROT)() {
  return &::cmrdv_interfaces::msg::rosidl_typesupport_introspection_cpp::PairROT_message_type_support_handle;
}
