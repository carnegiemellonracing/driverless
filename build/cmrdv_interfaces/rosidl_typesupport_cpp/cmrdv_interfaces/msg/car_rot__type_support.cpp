...
static const _CarROT_type_support_symbol_names_t _CarROT_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cmrdv_interfaces, msg, CarROT)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cmrdv_interfaces, msg, CarROT)),
  }
};
...
{
  return &::cmrdv_interfaces::msg::rosidl_typesupport_cpp::CarROT_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cmrdv_interfaces, msg, CarROT)() {
  return get_message_type_support_handle<cmrdv_interfaces::msg::CarROT>();
}
