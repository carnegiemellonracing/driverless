...
bool cmrdv_interfaces__msg__cone_list__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cmrdv_interfaces.msg._cone_list.ConeList", full_classname_dest, 40) == 0);
  }
  cmrdv_interfaces__msg__ConeList * ros_message = _ros_message;
  {  // blue_cones
...
{
  /* NOTE(esteve): Call constructor of ConeList */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("cmrdv_interfaces.msg._cone_list");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ConeList");
