...
bool cmrdv_interfaces__msg__vehicle_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cmrdv_interfaces.msg._vehicle_state.VehicleState", full_classname_dest, 48) == 0);
  }
  cmrdv_interfaces__msg__VehicleState * ros_message = _ros_message;
  {  // header
...
PyObject * cmrdv_interfaces__msg__vehicle_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("cmrdv_interfaces.msg._vehicle_state");
