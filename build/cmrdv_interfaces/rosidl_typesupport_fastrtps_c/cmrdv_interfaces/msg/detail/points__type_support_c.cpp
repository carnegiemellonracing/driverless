...
#include "cmrdv_interfaces/msg/detail/points__rosidl_typesupport_fastrtps_c.h"
...
using _Points__ros_msg_type = cmrdv_interfaces__msg__Points;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Points__ros_msg_type * ros_message = static_cast<const _Points__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Points__ros_msg_type * ros_message = static_cast<_Points__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_cmrdv_interfaces__msg__Points(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Points__ros_msg_type * ros_message = static_cast<const _Points__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Points__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cmrdv_interfaces__msg__Points(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cmrdv_interfaces
size_t max_serialized_size_cmrdv_interfaces__msg__Points(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_cmrdv_interfaces__msg__Points(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_Points = {
...
static rosidl_message_type_support_t _Points__type_support = {
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cmrdv_interfaces, msg, Points)() {
  return &_Points__type_support;
}
