...
#include "cmrdv_interfaces/msg/detail/cone_list__rosidl_typesupport_fastrtps_c.h"
...
using _ConeList__ros_msg_type = cmrdv_interfaces__msg__ConeList;
...
size_t get_serialized_size_cmrdv_interfaces__msg__ConeList(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ConeList__ros_msg_type * ros_message = static_cast<const _ConeList__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ConeList__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cmrdv_interfaces__msg__ConeList(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cmrdv_interfaces
size_t max_serialized_size_cmrdv_interfaces__msg__ConeList(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_cmrdv_interfaces__msg__ConeList(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cmrdv_interfaces, msg, ConeList)() {
