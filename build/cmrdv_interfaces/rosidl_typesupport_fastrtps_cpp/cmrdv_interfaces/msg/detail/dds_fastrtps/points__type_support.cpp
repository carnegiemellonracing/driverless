...
#include "cmrdv_interfaces/msg/detail/points__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const cmrdv_interfaces::msg::Points & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cmrdv_interfaces::msg::Points & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const cmrdv_interfaces::msg::Points *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cmrdv_interfaces::msg::Points *>(
    untyped_ros_message);
...
{
  return max_serialized_size_Points(full_bounded, 0);
}
...
{
  return &cmrdv_interfaces::msg::typesupport_fastrtps_cpp::_Points__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cmrdv_interfaces, msg, Points)() {
  return &cmrdv_interfaces::msg::typesupport_fastrtps_cpp::_Points__handle;
}
