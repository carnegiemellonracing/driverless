...
eufs_msgs__msg__WheelOdometryErr__init(eufs_msgs__msg__WheelOdometryErr * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    eufs_msgs__msg__WheelOdometryErr__fini(msg);
    return false;
  }
  // position_err
  // orientation_err
...
eufs_msgs__msg__WheelOdometryErr__are_equal(const eufs_msgs__msg__WheelOdometryErr * lhs, const eufs_msgs__msg__WheelOdometryErr * rhs)
{
  ...
  // forward_vel_err
  if (lhs->forward_vel_err != rhs->forward_vel_err) {
    return false;
  }
  return true;
}
  ...
  eufs_msgs__msg__WheelOdometryErr * output)
{
  ...
  // forward_vel_err
  output->forward_vel_err = input->forward_vel_err;
  return true;
}
...
eufs_msgs__msg__WheelOdometryErr__create()
{
  ...
  eufs_msgs__msg__WheelOdometryErr * msg = (eufs_msgs__msg__WheelOdometryErr *)allocator.allocate(sizeof(eufs_msgs__msg__WheelOdometryErr), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(eufs_msgs__msg__WheelOdometryErr));
  bool success = eufs_msgs__msg__WheelOdometryErr__init(msg);
  if (!success) {
...
eufs_msgs__msg__WheelOdometryErr__Sequence__init(eufs_msgs__msg__WheelOdometryErr__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  eufs_msgs__msg__WheelOdometryErr * data = NULL;

  if (size) {
    data = (eufs_msgs__msg__WheelOdometryErr *)allocator.zero_allocate(size, sizeof(eufs_msgs__msg__WheelOdometryErr), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = eufs_msgs__msg__WheelOdometryErr__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        eufs_msgs__msg__WheelOdometryErr__fini(&data[i - 1]);
      }
...
eufs_msgs__msg__WheelOdometryErr__Sequence__fini(eufs_msgs__msg__WheelOdometryErr__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      eufs_msgs__msg__WheelOdometryErr__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  eufs_msgs__msg__WheelOdometryErr__Sequence * array = (eufs_msgs__msg__WheelOdometryErr__Sequence *)allocator.allocate(sizeof(eufs_msgs__msg__WheelOdometryErr__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = eufs_msgs__msg__WheelOdometryErr__Sequence__init(array, size);
  if (!success) {
...
eufs_msgs__msg__WheelOdometryErr__Sequence__destroy(eufs_msgs__msg__WheelOdometryErr__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    eufs_msgs__msg__WheelOdometryErr__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
eufs_msgs__msg__WheelOdometryErr__Sequence__are_equal(const eufs_msgs__msg__WheelOdometryErr__Sequence * lhs, const eufs_msgs__msg__WheelOdometryErr__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!eufs_msgs__msg__WheelOdometryErr__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  eufs_msgs__msg__WheelOdometryErr__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(eufs_msgs__msg__WheelOdometryErr);
    eufs_msgs__msg__WheelOdometryErr * data =
      (eufs_msgs__msg__WheelOdometryErr *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!eufs_msgs__msg__WheelOdometryErr__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          eufs_msgs__msg__WheelOdometryErr__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!eufs_msgs__msg__WheelOdometryErr__copy(
