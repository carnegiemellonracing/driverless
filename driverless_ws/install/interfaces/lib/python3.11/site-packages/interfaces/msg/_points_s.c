...
bool interfaces__msg__points__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._points.Points", full_classname_dest, 29) == 0);
  }
  interfaces__msg__Points * ros_message = _ros_message;
  {  // header
...
PyObject * interfaces__msg__points__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._points");
