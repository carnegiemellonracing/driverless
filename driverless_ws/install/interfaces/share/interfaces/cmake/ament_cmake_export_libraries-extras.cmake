...
set(_exported_libraries "interfaces__rosidl_generator_c;interfaces__rosidl_typesupport_c;interfaces__rosidl_typesupport_cpp")
...
if(NOT _exported_library_names STREQUAL "")
  ...
  while(_i LESS _length)
    ...
    if(NOT _library_dirs)
      ...
      if(NOT _lib)
        # warn about not existing library and later ignore it
        message(WARNING "Package 'interfaces' exports library '${_library_name}' with LIBRARY_DIRS '${_library_dirs}' which couldn't be found")
      endif()
    endif()
    if(_lib)
      list(APPEND interfaces_LIBRARIES ${_cfg} "${_lib}")
