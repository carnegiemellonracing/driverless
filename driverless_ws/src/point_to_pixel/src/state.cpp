...
namespace point_to_pixel {
    std::pair<double, double> state_manager::global_frame_to_local_frame(
    ...
    std::pair<Eigen::Vector3d, Eigen::Vector3d> state_manager::transform_point(
    ...
    std::pair<double, double> state_manager::motion_model_on_point(
    ...
    std::pair<double, double> state_manager::local_frame_to_local_frame(
    ...
    state state_manager::get_prev_state(
        const rclcpp::Logger &logger,
        uint64_t frame_time
    ) {
    ...
    void state_manager::update_vel_deque(geometry_msgs::msg::TwistStamped::SharedPtr msg)
    {
        vel_mutex.lock();
    ...
    void state_manager::update_yaw_deque(geometry_msgs::msg::Vector3Stamped::SharedPtr msg)
    {
        yaw_mutex.lock();
        // Deque Management and Updating
