...
eufs_msgs__msg__Heartbeat__create()
{
  ...
  eufs_msgs__msg__Heartbeat * msg = (eufs_msgs__msg__Heartbeat *)allocator.allocate(sizeof(eufs_msgs__msg__Heartbeat), allocator.state);
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__Heartbeat__Sequence__init(eufs_msgs__msg__Heartbeat__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__Heartbeat *)allocator.zero_allocate(size, sizeof(eufs_msgs__msg__Heartbeat), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  eufs_msgs__msg__Heartbeat__Sequence * array = (eufs_msgs__msg__Heartbeat__Sequence *)allocator.allocate(sizeof(eufs_msgs__msg__Heartbeat__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
