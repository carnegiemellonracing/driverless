...
bool eufs_msgs__msg__cone_array_with_covariance__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("eufs_msgs.msg._cone_array_with_covariance.ConeArrayWithCovariance", full_classname_dest, 65) == 0);
  }
  eufs_msgs__msg__ConeArrayWithCovariance * ros_message = _ros_message;
  {  // header
  ...
  {  // blue_cones
    ...
    eufs_msgs__msg__ConeWithCovariance * dest = ros_message->blue_cones.data;
  ...
  {  // yellow_cones
    ...
    eufs_msgs__msg__ConeWithCovariance * dest = ros_message->yellow_cones.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!eufs_msgs__msg__cone_with_covariance__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
  ...
  {  // orange_cones
    ...
    eufs_msgs__msg__ConeWithCovariance * dest = ros_message->orange_cones.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!eufs_msgs__msg__cone_with_covariance__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
  ...
  {  // big_orange_cones
    ...
    eufs_msgs__msg__ConeWithCovariance * dest = ros_message->big_orange_cones.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!eufs_msgs__msg__cone_with_covariance__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
  ...
  {  // unknown_color_cones
    ...
    eufs_msgs__msg__ConeWithCovariance * dest = ros_message->unknown_color_cones.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!eufs_msgs__msg__cone_with_covariance__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of ConeArrayWithCovariance */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("eufs_msgs.msg._cone_array_with_covariance");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ConeArrayWithCovariance");
