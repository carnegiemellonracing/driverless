...
bool interfaces__msg__cone_list__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._cone_list.ConeList", full_classname_dest, 34) == 0);
  }
  interfaces__msg__ConeList * ros_message = _ros_message;
  {  // blue_cones
...
PyObject * interfaces__msg__cone_list__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._cone_list");
