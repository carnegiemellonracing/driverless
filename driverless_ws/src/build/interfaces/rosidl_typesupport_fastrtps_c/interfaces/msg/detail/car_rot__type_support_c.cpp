...
#include "interfaces/msg/detail/car_rot__rosidl_typesupport_fastrtps_c.h"
...
using _CarROT__ros_msg_type = interfaces__msg__CarROT;
...
static uint32_t _CarROT__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__msg__CarROT(
...
static size_t _CarROT__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__msg__CarROT(
