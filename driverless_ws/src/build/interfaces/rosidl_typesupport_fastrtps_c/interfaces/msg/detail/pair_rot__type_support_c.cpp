...
#include "interfaces/msg/detail/pair_rot__rosidl_typesupport_fastrtps_c.h"
...
#include "interfaces/msg/detail/car_rot__functions.h"  // far, near
#include "std_msgs/msg/detail/header__functions.h"  // header

// forward declare type support functions
size_t get_serialized_size_interfaces__msg__CarROT(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_interfaces__msg__CarROT(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, msg, CarROT)();
...
using _PairROT__ros_msg_type = interfaces__msg__PairROT;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: near
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, interfaces, msg, CarROT
      )()->data);
    if (!callbacks->cdr_serialize(
...
size_t get_serialized_size_interfaces__msg__PairROT(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PairROT__ros_msg_type * ros_message = static_cast<const _PairROT__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_interfaces__msg__CarROT(
...
static uint32_t _PairROT__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__msg__PairROT(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__msg__PairROT(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: near
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        max_serialized_size_interfaces__msg__CarROT(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
static size_t _PairROT__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__msg__PairROT(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, msg, PairROT)() {
