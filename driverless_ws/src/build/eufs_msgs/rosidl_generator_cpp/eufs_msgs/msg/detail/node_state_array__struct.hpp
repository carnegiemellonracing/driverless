...
struct NodeStateArray_
{
  ...
  _header_type header;
  using _states_type =
    std::vector<eufs_msgs::msg::NodeState_<ContainerAllocator>, typename ContainerAllocator::template rebind<eufs_msgs::msg::NodeState_<ContainerAllocator>>::other>;
  _states_type states;
  ...
  Type & set__states(
    const std::vector<eufs_msgs::msg::NodeState_<ContainerAllocator>, typename ContainerAllocator::template rebind<eufs_msgs::msg::NodeState_<ContainerAllocator>>::other> & _arg)
  {
    this->states = _arg;
    return *this;
  }
