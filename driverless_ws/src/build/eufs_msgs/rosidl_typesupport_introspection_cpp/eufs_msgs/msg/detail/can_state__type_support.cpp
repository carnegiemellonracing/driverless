...
{
  new (message_memory) eufs_msgs::msg::CanState(_init);
}

void CanState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<eufs_msgs::msg::CanState *>(message_memory);
  typed_message->~CanState();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember CanState_message_member_array[2] = {
  {
    "as_state",  // name
    ...
    offsetof(eufs_msgs::msg::CanState, as_state),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(eufs_msgs::msg::CanState, ami_state),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::eufs_msgs::msg::rosidl_typesupport_introspection_cpp::CanState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, eufs_msgs, msg, CanState)() {
  return &::eufs_msgs::msg::rosidl_typesupport_introspection_cpp::CanState_message_type_support_handle;
}
