...
bool eufs_msgs__msg__point_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("eufs_msgs.msg._point_array.PointArray", full_classname_dest, 37) == 0);
  }
  eufs_msgs__msg__PointArray * ros_message = _ros_message;
  {  // points
...
PyObject * eufs_msgs__msg__point_array__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("eufs_msgs.msg._point_array");
