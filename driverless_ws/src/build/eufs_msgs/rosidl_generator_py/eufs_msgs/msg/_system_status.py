...
class Metaclass_SystemStatus(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from eufs_msgs.msg import TopicStatus
...
class SystemStatus(metaclass=Metaclass_SystemStatus):
    ...
    _fields_and_field_types = {
        ...
        'topic_statuses': 'sequence<eufs_msgs/TopicStatus>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['eufs_msgs', 'msg'], 'TopicStatus')),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        self.topic_statuses = kwargs.get('topic_statuses', [])
    ...
    def __eq__(self, other):
        ...
        if self.header != other.header:
            return False
        if self.topic_statuses != other.topic_statuses:
            return False
        return True
    ...
    def topic_statuses(self):
        """Message field 'topic_statuses'."""
        return self._topic_statuses

    @topic_statuses.setter
    def topic_statuses(self, value):
        if __debug__:
            from eufs_msgs.msg import TopicStatus
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'topic_statuses' field must be a set or sequence and each value of type 'TopicStatus'"
        self._topic_statuses = value
