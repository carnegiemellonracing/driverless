...
bool eufs_msgs__msg__node_state_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("eufs_msgs.msg._node_state_array.NodeStateArray", full_classname_dest, 46) == 0);
  }
  eufs_msgs__msg__NodeStateArray * ros_message = _ros_message;
  {  // header
  ...
  {  // states
    ...
    if (!eufs_msgs__msg__NodeState__Sequence__init(&(ros_message->states), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create eufs_msgs__msg__NodeState__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    eufs_msgs__msg__NodeState * dest = ros_message->states.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!eufs_msgs__msg__node_state__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * eufs_msgs__msg__node_state_array__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("eufs_msgs.msg._node_state_array");
  ...
  {  // states
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = eufs_msgs__msg__node_state__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
