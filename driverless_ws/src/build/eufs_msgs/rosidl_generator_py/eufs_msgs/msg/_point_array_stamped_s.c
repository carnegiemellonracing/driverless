...
bool eufs_msgs__msg__point_array_stamped__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("eufs_msgs.msg._point_array_stamped.PointArrayStamped", full_classname_dest, 52) == 0);
  }
  eufs_msgs__msg__PointArrayStamped * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of PointArrayStamped */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("eufs_msgs.msg._point_array_stamped");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PointArrayStamped");
