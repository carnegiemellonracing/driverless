...
class ConeArray(metaclass=Metaclass_ConeArray):
    ...
    _fields_and_field_types = {
        ...
        'big_orange_cones': 'sequence<geometry_msgs/Point>',
        'unknown_color_cones': 'sequence<geometry_msgs/Point>',
    }
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, Point) for v in value) and
                 True), \
                "The 'big_orange_cones' field must be a set or sequence and each value of type 'Point'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, Point) for v in value) and
                 True), \
                "The 'unknown_color_cones' field must be a set or sequence and each value of type 'Point'"
