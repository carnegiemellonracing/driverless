...
#include <stddef.h>
#include "eufs_msgs/msg/detail/can_state__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  eufs_msgs__msg__CanState__init(message_memory);
}

void CanState__rosidl_typesupport_introspection_c__CanState_fini_function(void * message_memory)
{
  eufs_msgs__msg__CanState__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember CanState__rosidl_typesupport_introspection_c__CanState_message_member_array[2] = {
  {
    "as_state",  // name
    ...
    offsetof(eufs_msgs__msg__CanState, as_state),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(eufs_msgs__msg__CanState, ami_state),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers CanState__rosidl_typesupport_introspection_c__CanState_message_members = {
  ...
  2,  // number of fields
  sizeof(eufs_msgs__msg__CanState),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, eufs_msgs, msg, CanState)() {
