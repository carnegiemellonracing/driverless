...
size_t NodeStateArray__rosidl_typesupport_introspection_c__size_function__NodeState__states(
...
const void * NodeStateArray__rosidl_typesupport_introspection_c__get_const_function__NodeState__states(
...
void * NodeStateArray__rosidl_typesupport_introspection_c__get_function__NodeState__states(
...
bool NodeStateArray__rosidl_typesupport_introspection_c__resize_function__NodeState__states(
...
static rosidl_typesupport_introspection_c__MessageMember NodeStateArray__rosidl_typesupport_introspection_c__NodeStateArray_message_member_array[2] = {
  {
    "header",  // name
  ...
  },
  {
    ...
    NULL,  // default value
    NodeStateArray__rosidl_typesupport_introspection_c__size_function__NodeState__states,  // size() function pointer
    NodeStateArray__rosidl_typesupport_introspection_c__get_const_function__NodeState__states,  // get_const(index) function pointer
    NodeStateArray__rosidl_typesupport_introspection_c__get_function__NodeState__states,  // get(index) function pointer
    NodeStateArray__rosidl_typesupport_introspection_c__resize_function__NodeState__states  // resize(index) function pointer
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, eufs_msgs, msg, NodeStateArray)() {
  NodeStateArray__rosidl_typesupport_introspection_c__NodeStateArray_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
  NodeStateArray__rosidl_typesupport_introspection_c__NodeStateArray_message_member_array[1].members_ =
