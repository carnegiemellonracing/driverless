...
#include <stddef.h>
#include "eufs_msgs/msg/detail/runstop__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember Runstop__rosidl_typesupport_introspection_c__Runstop_message_member_array[3] = {
  {
    ...
    offsetof(eufs_msgs__msg__Runstop, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(eufs_msgs__msg__Runstop, sender),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(eufs_msgs__msg__Runstop, motion_enabled),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Runstop__rosidl_typesupport_introspection_c__Runstop_message_members = {
  ...
  3,  // number of fields
  sizeof(eufs_msgs__msg__Runstop),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, eufs_msgs, msg, Runstop)() {
