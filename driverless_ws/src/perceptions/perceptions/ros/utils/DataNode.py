...
class DataNode(Node):
    ...
    def update_data_time_points(self, msg_type, time_header):
        n = time_header.stamp.sec * 10**9
        n += time_header.stamp.nanosec
        self.data_times[msg_type] = Time(nanoseconds=n)
    ...
    def points_callback(self, msg):
        self.update_data_time_points(DataType.HESAI_POINTCLOUD, msg.header)
