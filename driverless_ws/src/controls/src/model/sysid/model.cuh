...
static constexpr float rolling_drag_constant_kN = 0.147287f;
static constexpr float rolling_drag_linear = 12.604f;
static constexpr float rolling_drag_squared = 0.0f;
static constexpr float understeer_slope_squared = 0.28980572;
static constexpr float torque_efficiency = 0.75152479f;
