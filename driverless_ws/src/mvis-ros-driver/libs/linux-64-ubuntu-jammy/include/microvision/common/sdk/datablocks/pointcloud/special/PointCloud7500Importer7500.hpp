...
//! \file
//!
//! \brief Deserialize data container PointCloud7500 from stream.
//!
...
template<>
class Importer<PointCloud7500, DataTypeId::DataType_PointCloud7500>
  : public RegisteredImporter<PointCloud7500, DataTypeId::DataType_PointCloud7500>
{
public:
    //========================================
...
}; // PointCloud7500Importer7500

//==============================================================================

using PointCloud7500Importer7500 = Importer<PointCloud7500, DataTypeId::DataType_PointCloud7500>;
