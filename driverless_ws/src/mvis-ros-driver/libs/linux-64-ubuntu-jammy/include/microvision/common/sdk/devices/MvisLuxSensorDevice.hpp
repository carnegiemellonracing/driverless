...
#include <microvision/common/sdk/devices/MvisLux.hpp>
...
//! \extends Commander
//------------------------------------------------------------------------------
class MvisLuxSensorDevice final : public IdcDevice, public Commander, private IdcDataPackageListener
{
public:
    //========================================
...
private:
    ...
    //----------------------------------------
    static constexpr const char* m_loggerId = "microvision::common::sdk::MvisLuxSensorDevice";
...
private:
    ...
    //========================================
    //! \brief Obsolete MvisLux device which is wrapped in this class.
    //----------------------------------------
    std::unique_ptr<MvisLux> m_delegate;

    //========================================
    //! \brief Async command results.
    //----------------------------------------
    std::list<std::future<void>> m_commandResults;
}; // class MvisLuxSensorDevice

//==============================================================================
//! \brief Pointer type of LUX sensor device.
//------------------------------------------------------------------------------
using MvisLuxSensorDevicePtr = std::unique_ptr<MvisLuxSensorDevice>;
