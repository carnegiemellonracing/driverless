...
class CommandMiniLuxGetStatusC final : public MiniLuxCommandC<CommandId::Id::CmdLuxGetStatus>
{
...
public:
    ...
    constexpr static const char* const containerType{"sdk.specialcontainer.command2010.commandminiluxgetstatus"};

    static constexpr uint64_t getClassIdHashStatic() { return hash(containerType); }

public:
    CommandMiniLuxGetStatusC() : MiniLuxCommandC<CommandId::Id::CmdLuxGetStatus>() {}
...
}; // CommandMiniLuxGetStatusC

//==============================================================================
//==============================================================================
//==============================================================================

inline bool operator==(const CommandMiniLuxGetStatusC& lhs, const CommandMiniLuxGetStatusC& rhs)
{
