...
//==============================================================================
//! \brief This is the importer for lane markings.
//!
//! Imports a Bytestream into a laneMarkingList6901
//------------------------------------------------------------------------------
template<>
class Importer<LaneMarkingList6901, static_cast<DataTypeId::DataType>(DataTypeId::DataType_LaneMarkingList6901)>
  : public RegisteredImporter<LaneMarkingList6901,
...
private:
    ...
    //----------------------------------------
    static bool deserialize(std::istream& is, lanes::LaneMarkingIn6901& c);
    ...
    //!\return \c True if deserialization succeeded, otherwise: \c false
    //----------------------------------------
    static bool deserialize(std::istream& is, lanes::LaneMarkingSegmentIn6901& c);
    ...
    //!\return \c True if deserialization succeeded, otherwise: \c false
    //----------------------------------------
    static bool deserialize(std::istream& is, lanes::LaneMarkingPointIn6901& c);
}; //LaneMarkingList6901Importer6901

//==============================================================================

using LaneMarkingList6901Importer6901
    = Importer<LaneMarkingList6901, static_cast<DataTypeId::DataType>(DataTypeId::DataType_LaneMarkingList6901)>;
