...
//------------------------------------------------------------------------------
class MICROVISION_SDK_DEPRECATED ScanPointIn2341 final
{
public:
    //========================================
    //! \brief Default constructor.
    //----------------------------------------
    ScanPointIn2341() = default;
    ...
    //----------------------------------------
    ScanPointIn2341(const ScanPointIn2341& src) = default;
    ...
    //! \return this
    //----------------------------------------
    ScanPointIn2341& operator=(const ScanPointIn2341& src) = default;
...
//------------------------------------------------------------------------------
bool operator==(const ScanPointIn2341& lhs, const ScanPointIn2341& rhs);
...
//------------------------------------------------------------------------------
inline bool operator!=(const ScanPointIn2341& lhs, const ScanPointIn2341& rhs) { return !(lhs == rhs); }
