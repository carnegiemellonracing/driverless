...
//==============================================================================
//! Exporter for specialized image data container 0x2405 to binary data
//! in stream.
//------------------------------------------------------------------------------
template<>
class Exporter<microvision::common::sdk::Image2405, DataTypeId::DataType_Image2405>
  : public TypedExporter<microvision::common::sdk::Image2405, DataTypeId::DataType_Image2405>
{
public:
    //========================================
...
}; // Image2405Exporter2405

//==============================================================================

using Image2405Exporter2405 = Exporter<microvision::common::sdk::Image2405, DataTypeId::DataType_Image2405>;
