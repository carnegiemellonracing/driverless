...
template<>
class SpecialImporter<Command2010, DataTypeId::DataType_Command2010, CommandLuxStartMeasureC>
  : public SpecialRegisteredImporter<Command2010, DataTypeId::DataType_Command2010, CommandLuxStartMeasureC>
{
public:
...
public:
    SpecialImporter()
      : SpecialRegisteredImporter<Command2010, DataTypeId::DataType_Command2010, CommandLuxStartMeasureC>()
    {}
...
using CommandLuxStartMeasure2010Importer2010
    = SpecialImporter<Command2010, DataTypeId::DataType_Command2010, CommandLuxStartMeasureC>;
