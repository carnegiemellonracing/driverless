...
//! \file
//!
//! \brief Imports vehicleState type 0x2807 to general vehicle state container
//!
...
template<>
class Importer<VehicleState, DataTypeId::DataType_VehicleStateBasic2807>
  : public RegisteredImporter<VehicleState, DataTypeId::DataType_VehicleStateBasic2807>
{
public:
    constexpr static const std::streamsize serializedSize{90};
...
using VehicleStateImporter2807 = Importer<VehicleState, DataTypeId::DataType_VehicleStateBasic2807>;
