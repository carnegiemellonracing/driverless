...
class ParameterIndex final : public microvision::common::sdk::ComparableUnconvertable<uint16_t>
{
public:
    explicit ParameterIndex(const uint16_t index) : microvision::common::sdk::ComparableUnconvertable<uint16_t>(index)
    {}
