...
template<>
class Exporter<LogMessage, DataTypeId::DataType_LogDebug6430>
  : public TypedExporter<LogMessage, DataTypeId::DataType_LogDebug6430>, protected LogMessageExporter<LogMessage>
{
public:
    //========================================
...
}; // LogMessageExporter6430

//==============================================================================

using LogMessageExporter6430 = Exporter<LogMessage, DataTypeId::DataType_LogDebug6430>;
