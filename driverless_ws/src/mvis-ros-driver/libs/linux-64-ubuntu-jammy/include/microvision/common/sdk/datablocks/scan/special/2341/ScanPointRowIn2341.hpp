...
#include <microvision/common/sdk/datablocks/scan/special/2341/ScanPointIn2341.hpp>
...
//------------------------------------------------------------------------------
class MICROVISION_SDK_DEPRECATED ScanPointRowIn2341 final
{
public:
...
public:
    using EchoArray  = std::array<ScanPointIn2341, nbOfEchos>;
...
public:
    ...
    //----------------------------------------
    ScanPointRowIn2341(const ScanPointRowIn2341& src) = default;
    ...
    //! \return this
    //----------------------------------------
    ScanPointRowIn2341& operator=(const ScanPointRowIn2341& src) = default;
...
//------------------------------------------------------------------------------
bool operator==(const ScanPointRowIn2341& lhs, const ScanPointRowIn2341& rhs);
...
//------------------------------------------------------------------------------
inline bool operator!=(const ScanPointRowIn2341& lhs, const ScanPointRowIn2341& rhs) { return !(lhs == rhs); }
