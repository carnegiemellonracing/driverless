...
#include <microvision/common/sdk/datablocks/commands/miniluxcommands/CommandMiniLuxGetParameterC.hpp>
...
template<>
class SpecialImporter<Command2010, DataTypeId::DataType_Command2010, CommandMiniLuxGetParameterC>
  : public SpecialRegisteredImporter<Command2010, DataTypeId::DataType_Command2010, CommandMiniLuxGetParameterC>
{
public:
...
public:
    SpecialImporter()
      : SpecialRegisteredImporter<Command2010, DataTypeId::DataType_Command2010, CommandMiniLuxGetParameterC>()
    {}
...
using CommandMiniLuxGetParameter2010Importer2010
    = SpecialImporter<Command2010, DataTypeId::DataType_Command2010, CommandMiniLuxGetParameterC>;
