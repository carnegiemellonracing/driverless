...
private:
    static constexpr const char* loggerId{"microvision::common::sdk::ScanImporter2209"};
...
using ScanImporter2209 = Importer<microvision::common::sdk::Scan, DataTypeId::DataType_Scan2209>;
