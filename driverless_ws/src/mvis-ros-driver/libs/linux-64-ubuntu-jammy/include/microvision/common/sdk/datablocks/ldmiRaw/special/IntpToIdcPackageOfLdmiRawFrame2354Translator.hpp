...
//! \file
//!
//! \brief Translate intp to idc packages of 0x2354 data containers from data stream.
//!
...
//------------------------------------------------------------------------------
class IntpToIdcPackageOfLdmiRawFrame2354Translator final
...
private:
    ...
    //----------------------------------------
    using StaticInfoIndexerType = std::map<uint64_t, LdmiRawStaticInfoIn2354>;

private:
    //========================================
    //! \brief Logger name to set up configuration.
    //----------------------------------------
    static constexpr const char* m_loggerId{"microvision::common::sdk::IntpToIdcPackageOfLdmiRawFrame2354Translator"};
...
public:
    ...
    //----------------------------------------
    IntpToIdcPackageOfLdmiRawFrame2354Translator();

    //========================================
    //! \brief Construct instance with output callback.
    //! \param[in] outputCallback  Output callback for created idc packages.
    //----------------------------------------
    IntpToIdcPackageOfLdmiRawFrame2354Translator(const BaseType::OutputCallback& outputCallback);

    //========================================
    //! \brief Copy constructor.
    //! \param[in] other  Other instance of IntpToIdcPackageOfLdmiRawFrame2354Translator.
    //----------------------------------------
    IntpToIdcPackageOfLdmiRawFrame2354Translator(const IntpToIdcPackageOfLdmiRawFrame2354Translator& other);

    //========================================
    //! \brief Move constructor disabled.
    //----------------------------------------
    IntpToIdcPackageOfLdmiRawFrame2354Translator(IntpToIdcPackageOfLdmiRawFrame2354Translator&&) = delete;

    //========================================
    //! \brief Default destructor.
    //----------------------------------------
    ~IntpToIdcPackageOfLdmiRawFrame2354Translator() override;
...
public:
    ...
    //! \param[in] other  Other instance of IntpToIdcPackageOfLdmiRawFrame2354Translator.
    //----------------------------------------
    IntpToIdcPackageOfLdmiRawFrame2354Translator& operator=(const IntpToIdcPackageOfLdmiRawFrame2354Translator& other);

    //========================================
    //! \brief Move assignment operator disabled.
    //----------------------------------------
    IntpToIdcPackageOfLdmiRawFrame2354Translator& operator=(IntpToIdcPackageOfLdmiRawFrame2354Translator&&) = delete;
...
public: // setter
    ...
    //----------------------------------------
    void setStaticInfo(const LdmiRawStaticInfoIn2354& staticInfo);
...
public: // implements DataStreamTranslator<IntpNetworkDataPackage, IdcDataPackage>
    ...
    //========================================
    //! \brief Translate IntpNetworkDataPackage to IdcDataPackage of LdmiRawFrame2354.
...
private:
    ...
    //----------------------------------------
    bool storeLdmiStaticInfo(SensorData& data, const LdmiRawStaticInfoIn2354& staticInfo);
    ...
    //! \return Either \c true if the processing was successful, otherwise \c false.
    //----------------------------------------
    bool storeLdmiHeader(SensorData& data, const LdmiRawFrameHeaderIn2354& frameHeader);
    ...
    //! \return Either \c true if the processing was successful, otherwise \c false.
    //----------------------------------------
    bool storeLdmiRow(SensorData& data, const LdmiRawFrameRowIn2354& frameRow);
    ...
    //! \return Either \c true if the processing was successful, otherwise \c false.
    //----------------------------------------
    bool storeLdmiFooter(SensorData& data, const LdmiRawFrameFooterIn2354& frameFooter);
    ...
    //========================================
    //! \brief Find and set the static info for the frame.
    //!
    //! \param[in]      configId  Wanted frame reference id.
    //! \param[in, out] frame     Frame needing a static info.
    //!
    //! \return Returns either \c true if a matching (by frame reference id) static info was found and set to the frame.
    //----------------------------------------
    bool setFrameStaticInfo(uint64_t configId, const LdmiRawFrame2354Ptr& frame);
...
}; // class IntpToIdcPackageOfLdmiRawFrame2354Translator

//==============================================================================
//! \brief Nullable IntpToIdcPackageOfLdmiRawFrame2354Translator pointer.
//------------------------------------------------------------------------------
using IntpToIdcPackageOfLdmiRawFrame2354TranslatorPtr = std::shared_ptr<IntpToIdcPackageOfLdmiRawFrame2354Translator>;
