...
//!        it into a Scan2341 data container.
//------------------------------------------------------------------------------
template<>
class MICROVISION_SDK_DEPRECATED Importer<Scan2341, DataTypeId::DataType_Scan2340>
  : public RegisteredImporter<Scan2341, DataTypeId::DataType_Scan2340>
{
public:
    //========================================
...
private:
    static constexpr const char* loggerId{"microvision::common::sdk::Scan2341Importer2340"};
    static microvision::common::logging::LoggerSPtr logger;

}; //Scan2341Importer2340

//==============================================================================

using Scan2341Importer2340 = Importer<microvision::common::sdk::Scan2341, DataTypeId::DataType_Scan2340>;
