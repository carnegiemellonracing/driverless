...
template<>
class SpecialExporter<CommandLuxSetParameterC> : public SpecialExporterBase<CommandCBase>
{
public:
...
public:
    ...
    //!        can handle.
    //----------------------------------------
    virtual CommandCBase::KeyType getSpecialType() const override { return CommandLuxSetParameterC::key; }
...
using CommandLuxSetParameter2010Exporter2010 = SpecialExporter<CommandLuxSetParameterC>;
