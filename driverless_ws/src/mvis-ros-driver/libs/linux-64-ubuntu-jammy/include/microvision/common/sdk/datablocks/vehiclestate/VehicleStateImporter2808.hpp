...
//! \filee
//!
//! \brief Imports vehicleState type 0x2808 to general vehicle state container
//!
...
template<>
class Importer<VehicleState, DataTypeId::DataType_VehicleStateBasic2808>
  : public RegisteredImporter<VehicleState, DataTypeId::DataType_VehicleStateBasic2808>
{
public:
...
using VehicleStateImporter2808 = Importer<VehicleState, DataTypeId::DataType_VehicleStateBasic2808>;
