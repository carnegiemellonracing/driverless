...
#include <microvision/common/sdk/datablocks/logmessages/LogMessageImporter.hpp>
//==============================================================================
...
//! \brief LogMessage Importer WarningMsg
//!
//! Special data type:
//! \ref microvision::common::sdk::LogMessageWarning6410
template<>
class Importer<LogMessage, DataTypeId::DataType_LogWarning6410>
  : public RegisteredImporter<LogMessage, DataTypeId::DataType_LogWarning6410>, protected LogMessageImporter<LogMessage>
{
public:
...
}; //LogMessageImporter6410

//==============================================================================

using LogMessageImporter6410 = Importer<LogMessage, DataTypeId::DataType_LogWarning6410>;
