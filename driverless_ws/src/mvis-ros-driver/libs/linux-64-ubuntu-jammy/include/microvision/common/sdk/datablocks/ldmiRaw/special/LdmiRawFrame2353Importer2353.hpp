...
//! \file
//!
//! \brief Deserialize data container LdmiRawFrame2353 from stream.
//!
...
//------------------------------------------------------------------------------
template<>
class Importer<LdmiRawFrame2353, DataTypeId::DataType_LdmiRawFrame2353>
  : public RegisteredImporter<LdmiRawFrame2353, DataTypeId::DataType_LdmiRawFrame2353>
{
public:
    //========================================
...
}; // LdmiRawFrame2353Importer2353

//==============================================================================

using LdmiRawFrame2353Importer2353 = Importer<LdmiRawFrame2353, DataTypeId::DataType_LdmiRawFrame2353>;
