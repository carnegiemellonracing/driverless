...
//! \brief
//!
//! This class holds the configuration of the MVIS Sync Box used during this recording.
//------------------------------------------------------------------------------
class MetaInformationSyncBoxConfigIn7110 : public MetaInformationBaseIn7110
{
public:
    //========================================
    //! \brief Constructor.
    //!
    //! Initializes this instance as meta information of type sync box config.
    //----------------------------------------
    MetaInformationSyncBoxConfigIn7110()
      : MetaInformationBaseIn7110(MetaInformationBaseIn7110::MetaInformationType::SyncBoxConfig)
    {}

    //========================================
    //! \brief Destructor.
    //----------------------------------------
    ~MetaInformationSyncBoxConfigIn7110() override = default;

public:
    //========================================
    //! \brief Get the Sync Box configuration.
    //!
    //! \return The Sync Box configuration as string.
    //----------------------------------------
    const std::string& getSyncBoxConfig() const { return m_syncBoxConfig; }

    //========================================
    //! \brief Set the Sync Box configuration.
    //!
    //! \param[in] newSyncBoxConfig  The new Sync Box configuration as string.
    //----------------------------------------
    void setSyncBoxConfig(const std::string& newSyncBoxConfig);
