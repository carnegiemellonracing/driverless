...
//------------------------------------------------------------------------------
class BagRecordChunkStreamReader final : public BagStreamReaderBase
{
public:
    //========================================
...
private:
    ...
    //----------------------------------------
    static constexpr const char* m_loggerId = "microvision::common::sdk::BagRecordChunkStreamReader";
...
public:
    ...
    //! \param[in] chunk  Chunk record stream to read.
    //----------------------------------------
    explicit BagRecordChunkStreamReader(const BagChunkRecordPackage& chunk);

    //========================================
    //! \brief Move constructor.
    //----------------------------------------
    BagRecordChunkStreamReader(BagRecordChunkStreamReader&& reader);

    //========================================
    //! \brief Copy constructor disabled.
    //----------------------------------------
    BagRecordChunkStreamReader(const BagRecordChunkStreamReader&) = delete;

    //========================================
    //! \brief Default destructor.
    //----------------------------------------
    ~BagRecordChunkStreamReader() override;

public:
    //========================================
    //! \brief Move assignment operator.
    //----------------------------------------
    BagRecordChunkStreamReader& operator=(BagRecordChunkStreamReader&& reader);

    //========================================
    //! \brief Copy assignment operator disabled.
    //----------------------------------------
    BagRecordChunkStreamReader& operator=(const BagRecordChunkStreamReader& reader) = delete;
...
}; // class BagRecordChunkStreamReader
