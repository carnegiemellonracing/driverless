...
//! \brief Event marker importer
//!
//! Special data type: \ref microvision::common::sdk::EventMarker7001
template<>
class Importer<EventMarker, DataTypeId::DataType_EventMarker7001>
  : public RegisteredImporter<EventMarker, DataTypeId::DataType_EventMarker7001>
{
public:
...
}; //EventMarkerImporter7001

//==============================================================================

using EventMarkerImporter7001 = Importer<EventMarker, DataTypeId::DataType_EventMarker7001>;
