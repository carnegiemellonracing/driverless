...
template<>
class Exporter<LogMessage, DataTypeId::DataType_LogError6400>
  : public TypedExporter<LogMessage, DataTypeId::DataType_LogError6400>, protected LogMessageExporter<LogMessage>
{
public:
    //========================================
...
}; // LogMessageExporter6400

//==============================================================================

using LogMessageExporter6400 = Exporter<LogMessage, DataTypeId::DataType_LogError6400>;
