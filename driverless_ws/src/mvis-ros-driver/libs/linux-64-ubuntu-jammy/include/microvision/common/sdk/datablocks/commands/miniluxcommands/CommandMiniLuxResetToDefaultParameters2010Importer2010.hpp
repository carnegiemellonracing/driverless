...
template<>
class SpecialImporter<Command2010, DataTypeId::DataType_Command2010, CommandMiniLuxResetToDefaultParametersC>
  : public SpecialRegisteredImporter<Command2010,
...
public:
    SpecialImporter()
      : SpecialRegisteredImporter<Command2010,
                                  DataTypeId::DataType_Command2010,
                                  CommandMiniLuxResetToDefaultParametersC>()
    {}
...
using CommandMiniLuxResetToDefaultParameters2010Importer2010
    = SpecialImporter<Command2010, DataTypeId::DataType_Command2010, CommandMiniLuxResetToDefaultParametersC>;
