...
//==============================================================================
//! \brief Importer for Image from 2405.
//!
//! Importer for general data container type Image from serialized binary data
//! stream of specialized 2405 data container type.
//------------------------------------------------------------------------------
template<>
class Importer<Image, DataTypeId::DataType_Image2405> : public RegisteredImporter<Image, DataTypeId::DataType_Image2405>
{
public:
    //========================================
...
using ImageImporter2405 = Importer<microvision::common::sdk::Image, DataTypeId::DataType_Image2405>;
