...
set_target_properties(microvision-common-logging::logging PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libmicrovision-common-logging.lib"
  )

list(APPEND _IMPORT_CHECK_TARGETS microvision-common-logging::logging )
list(APPEND _IMPORT_CHECK_FILES_FOR_microvision-common-logging::logging "${_IMPORT_PREFIX}/lib/libmicrovision-common-logging.lib" )
