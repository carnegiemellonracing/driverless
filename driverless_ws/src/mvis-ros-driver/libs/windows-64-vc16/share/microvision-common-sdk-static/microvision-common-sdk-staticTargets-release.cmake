...
set_target_properties(microvision-common::sdk-core PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libmicrovision-common-sdk-core.lib"
  )

list(APPEND _IMPORT_CHECK_TARGETS microvision-common::sdk-core )
list(APPEND _IMPORT_CHECK_FILES_FOR_microvision-common::sdk-core "${_IMPORT_PREFIX}/lib/libmicrovision-common-sdk-core.lib" )
...
set_target_properties(microvision-common::sdk-data PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libmicrovision-common-sdk-data.lib"
  )

list(APPEND _IMPORT_CHECK_TARGETS microvision-common::sdk-data )
list(APPEND _IMPORT_CHECK_FILES_FOR_microvision-common::sdk-data "${_IMPORT_PREFIX}/lib/libmicrovision-common-sdk-data.lib" )
...
set_target_properties(microvision-common::sdk-devices PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libmicrovision-common-sdk-devices.lib"
  )

list(APPEND _IMPORT_CHECK_TARGETS microvision-common::sdk-devices )
list(APPEND _IMPORT_CHECK_FILES_FOR_microvision-common::sdk-devices "${_IMPORT_PREFIX}/lib/libmicrovision-common-sdk-devices.lib" )
