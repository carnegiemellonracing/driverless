...
set_target_properties(microvision-common::sdk-test-support PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tests/lib/libmicrovision-common-sdk-test-support.lib"
  )

list(APPEND _IMPORT_CHECK_TARGETS microvision-common::sdk-test-support )
list(APPEND _IMPORT_CHECK_FILES_FOR_microvision-common::sdk-test-support "${_IMPORT_PREFIX}/tests/lib/libmicrovision-common-sdk-test-support.lib" )
