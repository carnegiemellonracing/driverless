...
template<>
class Importer<Notification, DataTypeId::DataType_Notification2030>
  : public RegisteredImporter<Notification, DataTypeId::DataType_Notification2030>
{
public:
    //========================================
    //! \brief Constructor.
...
}; //NotificationImporter2030

//==============================================================================

using NotificationImporter2030
    = Importer<microvision::common::sdk::Notification, DataTypeId::DataType_Notification2030>;
