...
//! \brief LogMessage Importer NoteMsg
//!
//! Special data type:
//! \ref microvision::common::sdk::LogMessageNote6420
template<>
class Importer<LogMessage, DataTypeId::DataType_LogNote6420>
  : public RegisteredImporter<LogMessage, DataTypeId::DataType_LogNote6420>, protected LogMessageImporter<LogMessage>
{
public:
...
}; //LogMessageImporter6420

//==============================================================================

using LogMessageImporter6420 = Importer<LogMessage, DataTypeId::DataType_LogNote6420>;
