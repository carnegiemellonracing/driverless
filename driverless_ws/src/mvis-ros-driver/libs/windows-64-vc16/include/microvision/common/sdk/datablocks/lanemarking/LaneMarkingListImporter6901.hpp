...
//------------------------------------------------------------------------------
template<>
class Importer<LaneMarkingList, static_cast<DataTypeId::DataType>(DataTypeId::DataType_LaneMarkingList6901)>
  : public RegisteredImporter<LaneMarkingList,
...
}; //LaneMarkingListImporter6901

//==============================================================================

using LaneMarkingListImporter6901
    = Importer<LaneMarkingList, static_cast<DataTypeId::DataType>(DataTypeId::DataType_LaneMarkingList6901)>;
