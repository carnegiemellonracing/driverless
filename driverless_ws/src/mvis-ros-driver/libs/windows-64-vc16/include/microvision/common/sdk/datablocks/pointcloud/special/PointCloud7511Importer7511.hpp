...
//! \file
//!
//! \brief Deserialize data container PointCloud7511 from stream.
//!
...
//------------------------------------------------------------------------------
template<>
class Importer<PointCloud7511, DataTypeId::DataType_PointCloud7511>
  : public RegisteredImporter<PointCloud7511, DataTypeId::DataType_PointCloud7511>
{
public:
    //========================================
...
}; // PointCloud7511Importer7511

//==============================================================================

using PointCloud7511Importer7511 = Importer<PointCloud7511, DataTypeId::DataType_PointCloud7511>;
