...
//! \brief Mission Response Importer
//!
//! Special data type: \ref microvision::common::sdk::MissionResponse3540
template<>
class Importer<MissionResponse, DataTypeId::DataType_MissionResponse3540>
  : public RegisteredImporter<MissionResponse, DataTypeId::DataType_MissionResponse3540>
{
public:
...
}; //MissionResponseImporter3540

//==============================================================================

using MissionResponseImporter3540
    = Importer<microvision::common::sdk::MissionResponse, DataTypeId::DataType_MissionResponse3540>;
