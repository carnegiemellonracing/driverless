...
//! \file
//!
//! \brief Translate idc to intp packages of 0x2354 data containers from data stream.
//!
...
//------------------------------------------------------------------------------
class IdcToIntpPackageOfLdmiRawFrame2354Translator final
...
private:
    ...
    //----------------------------------------
    static constexpr const char* m_loggerId{"microvision::common::sdk::IdcToIntpPackageOfLdmiRawFrame2354Translator"};
...
public:
    ...
    //----------------------------------------
    IdcToIntpPackageOfLdmiRawFrame2354Translator();

    //========================================
    //! \brief Construct instance with output callback.
    //! \param[in] outputCallback  Output callback for created idc packages.
    //----------------------------------------
    IdcToIntpPackageOfLdmiRawFrame2354Translator(const BaseType::OutputCallback& outputCallback);

    //========================================
    //! \brief Copy constructor.
    //! \param[in] other  Other instance of IdcToIntpPackageOfLdmiRawFrame2354Translator.
    //----------------------------------------
    IdcToIntpPackageOfLdmiRawFrame2354Translator(const IdcToIntpPackageOfLdmiRawFrame2354Translator& other);

    //========================================
    //! \brief Move constructor disabled.
    //----------------------------------------
    IdcToIntpPackageOfLdmiRawFrame2354Translator(IdcToIntpPackageOfLdmiRawFrame2354Translator&&) = delete;

    //========================================
    //! \brief Default destructor.
    //----------------------------------------
    ~IdcToIntpPackageOfLdmiRawFrame2354Translator() override;
...
public:
    ...
    //! \param[in] other  Other instance of IdcToIntpPackageOfLdmiRawFrame2354Translator.
    //----------------------------------------
    IdcToIntpPackageOfLdmiRawFrame2354Translator& operator=(const IdcToIntpPackageOfLdmiRawFrame2354Translator& other);

    //========================================
    //! \brief Move assignment operator disabled.
    //----------------------------------------
    IdcToIntpPackageOfLdmiRawFrame2354Translator& operator=(IdcToIntpPackageOfLdmiRawFrame2354Translator&&) = delete;
...
public: // implements DataStreamTranslator<IdcDataPackage, IntpNetworkDataPackage>
    ...
    //========================================
    //! \brief Translate IdcDataPackage to IntpNetworkDataPackage of LdmiRawFrame2354.
...
}; // class IdcToIntpPackageOfLdmiRawFrame2354Translator

//==============================================================================
//! \brief Nullable IdcToIntpPackageOfLdmiRawFrame2354Translator pointer.
//------------------------------------------------------------------------------
using IdcToIntpPackageOfLdmiRawFrame2354TranslatorPtr = std::shared_ptr<IdcToIntpPackageOfLdmiRawFrame2354Translator>;
