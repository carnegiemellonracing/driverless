...
class CommandLuxGetStatusC : public LuxCommandC<CommandId::Id::CmdLuxGetStatus>
{
...
public:
    ...
    //----------------------------------------
    constexpr static const KeyType key{CommandId::Id::CmdLuxGetStatus};
    constexpr static const char* const containerType{"sdk.specialcontainer.command.commandluxgetstatus"};

    static constexpr uint64_t getClassIdHashStatic() { return hash(containerType); }

public:
    CommandLuxGetStatusC() : LuxCommandC<CommandId::Id::CmdLuxGetStatus>() {}
...
inline bool operator==(const CommandLuxGetStatusC& lhs, const CommandLuxGetStatusC& rhs)
{
...
inline bool operator!=(const CommandLuxGetStatusC& lhs, const CommandLuxGetStatusC& rhs) { return !(lhs == rhs); }
