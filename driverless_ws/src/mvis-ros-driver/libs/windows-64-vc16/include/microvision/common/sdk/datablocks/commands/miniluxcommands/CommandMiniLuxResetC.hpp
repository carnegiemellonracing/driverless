...
class CommandMiniLuxResetC final : public MiniLuxCommandC<CommandId::Id::CmdLuxReset>
{
...
public:
    ...
    constexpr static const char* const containerType{"sdk.specialcontainer.command2010.commandminiluxreset"};

    static constexpr uint64_t getClassIdHashStatic() { return hash(containerType); }

public:
    CommandMiniLuxResetC() : MiniLuxCommandC<CommandId::Id::CmdLuxReset>() {}
...
}; // CommandMiniLuxResetC

//==============================================================================
//==============================================================================
//==============================================================================

inline bool operator==(const CommandMiniLuxResetC& lhs, const CommandMiniLuxResetC& rhs)
{
...
inline bool operator!=(const CommandMiniLuxResetC& lhs, const CommandMiniLuxResetC& rhs) { return !(lhs == rhs); }
