...
template<>
class Importer<Image, DataTypeId::DataType_Image2403> : public RegisteredImporter<Image, DataTypeId::DataType_Image2403>
{
public:
    //========================================
...
using ImageImporter2403 = Importer<microvision::common::sdk::Image, DataTypeId::DataType_Image2403>;
