...
template<>
class Importer<IdcTrailer, DataTypeId::DataType_IdcTrailer6120>
  : public RegisteredImporter<IdcTrailer, DataTypeId::DataType_IdcTrailer6120>
{
public:
...
}; //IdcTrailerImporter6120

//==============================================================================

using IdcTrailerImporter6120 = Importer<microvision::common::sdk::IdcTrailer, DataTypeId::DataType_IdcTrailer6120>;
