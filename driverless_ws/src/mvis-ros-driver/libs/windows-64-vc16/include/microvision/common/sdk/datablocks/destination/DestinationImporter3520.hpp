...
template<>
class Importer<Destination, DataTypeId::DataType_Destination3520>
  : public RegisteredImporter<Destination, DataTypeId::DataType_Destination3520>
{
public:
...
}; //DestinationImporter3520

//==============================================================================

using DestinationImporter3520 = Importer<Destination, DataTypeId::DataType_Destination3520>;
