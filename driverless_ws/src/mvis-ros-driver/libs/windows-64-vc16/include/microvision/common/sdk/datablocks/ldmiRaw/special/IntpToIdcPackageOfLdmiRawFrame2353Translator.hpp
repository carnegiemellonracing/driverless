...
//! \file
//!
//! \brief Translate intp to idc packages of 0x2353 data containers from data stream.
//!
...
//------------------------------------------------------------------------------
class IntpToIdcPackageOfLdmiRawFrame2353Translator final
...
private:
    ...
    //----------------------------------------
    using StaticInfoIndexerType = std::map<uint64_t, LdmiRawStaticInfoIn2353>;

private:
    //========================================
    //! \brief Logger name to set up configuration.
    //----------------------------------------
    static constexpr const char* m_loggerId{"microvision::common::sdk::IntpToIdcPackageOfLdmiRawFrame2353Translator"};
...
public:
    ...
    //----------------------------------------
    IntpToIdcPackageOfLdmiRawFrame2353Translator();

    //========================================
    //! \brief Construct instance with output callback.
    //! \param[in] outputCallback  Output callback for created idc packages.
    //----------------------------------------
    IntpToIdcPackageOfLdmiRawFrame2353Translator(const BaseType::OutputCallback& outputCallback);

    //========================================
    //! \brief Copy constructor.
    //! \param[in] other  Other instance of IntpToIdcPackageOfLdmiRawFrame2353Translator.
    //----------------------------------------
    IntpToIdcPackageOfLdmiRawFrame2353Translator(const IntpToIdcPackageOfLdmiRawFrame2353Translator& other);

    //========================================
    //! \brief Move constructor disabled.
    //----------------------------------------
    IntpToIdcPackageOfLdmiRawFrame2353Translator(IntpToIdcPackageOfLdmiRawFrame2353Translator&&) = delete;

    //========================================
    //! \brief Default destructor.
    //----------------------------------------
    ~IntpToIdcPackageOfLdmiRawFrame2353Translator() override;
...
public:
    ...
    //! \param[in] other  Other instance of IntpToIdcPackageOfLdmiRawFrame2353Translator.
    //----------------------------------------
    IntpToIdcPackageOfLdmiRawFrame2353Translator& operator=(const IntpToIdcPackageOfLdmiRawFrame2353Translator& other);

    //========================================
    //! \brief Move assignment operator disabled.
    //----------------------------------------
    IntpToIdcPackageOfLdmiRawFrame2353Translator& operator=(IntpToIdcPackageOfLdmiRawFrame2353Translator&&) = delete;
...
public: // setter
    ...
    //----------------------------------------
    void setStaticInfo(const LdmiRawStaticInfoIn2353& staticInfo);
...
public: // implements DataStreamTranslator<IntpNetworkDataPackage, IdcDataPackage>
    ...
    //========================================
    //! \brief Translate IntpNetworkDataPackage to IdcDataPackage of LdmiRawFrame2353.
...
private:
    ...
    //----------------------------------------
    bool storeLdmiStaticInfo(SensorData& data, const LdmiRawStaticInfoIn2353& staticInfo);
    ...
    //! \return Either \c true if the processing was successful, otherwise \c false.
    //----------------------------------------
    bool storeLdmiHeader(SensorData& data, const LdmiRawFrameHeaderIn2353& frameHeader);
    ...
    //! \return Either \c true if the processing was successful, otherwise \c false.
    //----------------------------------------
    bool storeLdmiRow(SensorData& data, const LdmiRawFrameRowIn2353& frameRow);
    ...
    //! \return Either \c true if the processing was successful, otherwise \c false.
    //----------------------------------------
    bool storeLdmiFooter(SensorData& data, const LdmiRawFrameFooterIn2353& frameFooter);
    ...
    //----------------------------------------
    bool setFrameStaticInfo(uint64_t configId, const LdmiRawFrame2353Ptr& frame);
...
}; // class IntpToIdcPackageOfLdmiRawFrame2353Translator

//==============================================================================
//! \brief Nullable IntpToIdcPackageOfLdmiRawFrame2353Translator pointer.
//------------------------------------------------------------------------------
using IntpToIdcPackageOfLdmiRawFrame2353TranslatorPtr = std::shared_ptr<IntpToIdcPackageOfLdmiRawFrame2353Translator>;
