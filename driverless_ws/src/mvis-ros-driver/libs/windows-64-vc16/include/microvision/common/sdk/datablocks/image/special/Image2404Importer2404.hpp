...
//==============================================================================
//! \brief Data container 2404 importer.
//!
//! Importer for specialized image data container 0x2404 from binary data
//! in stream.
//------------------------------------------------------------------------------
template<>
class Importer<Image2404, DataTypeId::DataType_Image2404>
  : public RegisteredImporter<Image2404, DataTypeId::DataType_Image2404>
{
public:
    //========================================
...
}; //Image2404Importer2404

//==============================================================================

using Image2404Importer2404 = Importer<Image2404, DataTypeId::DataType_Image2404>;
