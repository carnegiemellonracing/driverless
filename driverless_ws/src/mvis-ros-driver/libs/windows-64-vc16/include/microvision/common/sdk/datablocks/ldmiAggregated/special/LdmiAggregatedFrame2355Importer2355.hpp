...
//! \file
//!
//! \brief Deserialize data container LdmiAggregatedFrame2355 from stream.
//!
...
//------------------------------------------------------------------------------
template<>
class Importer<LdmiAggregatedFrame2355, DataTypeId::DataType_LdmiAggregatedFrame2355>
  : public RegisteredImporter<LdmiAggregatedFrame2355, DataTypeId::DataType_LdmiAggregatedFrame2355>
{
public:
    //========================================
...
}; // LdmiAggregatedFrame2355Importer2355

//==============================================================================

using LdmiAggregatedFrame2355Importer2355
    = Importer<LdmiAggregatedFrame2355, DataTypeId::DataType_LdmiAggregatedFrame2355>;
