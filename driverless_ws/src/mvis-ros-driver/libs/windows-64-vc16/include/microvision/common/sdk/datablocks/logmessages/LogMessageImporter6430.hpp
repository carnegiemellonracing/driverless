...
//! \brief LogMessage Importer DebugMsg
//!
//! Special data type:
//! \ref microvision::common::sdk::LogMessageDebug6430
template<>
class Importer<LogMessage, DataTypeId::DataType_LogDebug6430>
  : public RegisteredImporter<LogMessage, DataTypeId::DataType_LogDebug6430>, protected LogMessageImporter<LogMessage>
{
public:
...
}; //LogMessageImporter6430

//==============================================================================

using LogMessageImporter6430 = Importer<LogMessage, DataTypeId::DataType_LogDebug6430>;
