...
template<>
class Exporter<LogMessage, DataTypeId::DataType_LogWarning6410>
  : public TypedExporter<LogMessage, DataTypeId::DataType_LogWarning6410>, protected LogMessageExporter<LogMessage>
{
public:
    //========================================
...
}; // LogMessageExporter6410

//==============================================================================

using LogMessageExporter6410 = Exporter<LogMessage, DataTypeId::DataType_LogWarning6410>;
