...
//! on their priority
//------------------------------------------------------------------------------
class LogMessageWarning6410 final : public LogMessage64x0Base, public SpecializedDataContainer
{
...
public:
    constexpr static const char* const containerType{"sdk.specialcontainer.logmessagewarning6410"};
