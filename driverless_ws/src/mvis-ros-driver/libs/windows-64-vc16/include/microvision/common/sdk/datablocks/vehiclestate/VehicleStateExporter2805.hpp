...
template<>
class Exporter<microvision::common::sdk::VehicleState, DataTypeId::DataType_VehicleStateBasic2805>
  : public TypedExporter<microvision::common::sdk::VehicleState, DataTypeId::DataType_VehicleStateBasic2805>
{
public:
