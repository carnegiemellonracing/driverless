...
template<>
class Importer<DeviceStatus6320, DataTypeId::DataType_DeviceStatus6320>
  : public RegisteredImporter<DeviceStatus6320, DataTypeId::DataType_DeviceStatus6320>
{
public:
...
public:
    static bool deserialize(std::istream& is, ErrorIn6320& error);
}; // DeviceStatus6320Importer6320

//==============================================================================

using DeviceStatus6320Importer6320 = Importer<DeviceStatus6320, DataTypeId::DataType_DeviceStatus6320>;
