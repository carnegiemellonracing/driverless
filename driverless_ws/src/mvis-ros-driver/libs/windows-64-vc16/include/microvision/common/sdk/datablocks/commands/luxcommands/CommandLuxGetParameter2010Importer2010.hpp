...
template<>
class SpecialImporter<Command2010, DataTypeId::DataType_Command2010, CommandLuxGetParameterC>
  : public SpecialRegisteredImporter<Command2010, DataTypeId::DataType_Command2010, CommandLuxGetParameterC>
{
public:
...
public:
    SpecialImporter()
      : SpecialRegisteredImporter<Command2010, DataTypeId::DataType_Command2010, CommandLuxGetParameterC>()
    {}
...
using CommandLuxGetParameter2010Importer2010
    = SpecialImporter<Command2010, DataTypeId::DataType_Command2010, CommandLuxGetParameterC>;
