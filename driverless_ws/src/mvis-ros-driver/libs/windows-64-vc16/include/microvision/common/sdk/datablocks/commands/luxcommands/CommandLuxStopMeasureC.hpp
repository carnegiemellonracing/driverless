...
class CommandLuxStopMeasureC final : public LuxCommandC<CommandId::Id::CmdLuxStopMeasure>
{
...
public:
    ...
    constexpr static const char* const containerType{"sdk.specialcontainer.command2010.commandluxstopmeasure"};

    static constexpr uint64_t getClassIdHashStatic() { return hash(containerType); }

public:
    CommandLuxStopMeasureC() : LuxCommandC<CommandId::Id::CmdLuxStopMeasure>() {}
...
inline bool operator==(const CommandLuxStopMeasureC& lhs, const CommandLuxStopMeasureC& rhs)
{
...
inline bool operator!=(const CommandLuxStopMeasureC& lhs, const CommandLuxStopMeasureC& rhs) { return !(lhs == rhs); }
