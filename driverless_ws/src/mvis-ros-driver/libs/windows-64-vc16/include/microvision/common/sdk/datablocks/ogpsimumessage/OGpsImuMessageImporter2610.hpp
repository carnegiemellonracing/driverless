...
template<>
class Importer<OGpsImuMessage, DataTypeId::DataType_OGpsImuMessage2610>
  : public RegisteredImporter<OGpsImuMessage, DataTypeId::DataType_OGpsImuMessage2610>
{
public:
    //========================================
...
}; //OGpsImuMessageImporter2610

//==============================================================================

using OGpsImuMessageImporter2610
    = Importer<microvision::common::sdk::OGpsImuMessage, DataTypeId::DataType_OGpsImuMessage2610>;
