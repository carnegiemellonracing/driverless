...
//==============================================================================
//! \brief This class is used to import a third party lidar raw data scan (data type 2321)
//!        from an IDC container into a scan object of the same type.
//------------------------------------------------------------------------------
template<>
class Importer<Scan2321, DataTypeId::DataType_Scan2321>
  : public RegisteredImporter<Scan2321, DataTypeId::DataType_Scan2321>
{
public:
    //========================================
...
}; // Scan2321Importer2321

//==============================================================================

using Scan2321Importer2321 = Importer<microvision::common::sdk::Scan2321, DataTypeId::DataType_Scan2321>;
