...
template<>
class Importer<Notification2030, DataTypeId::DataType_Notification2030>
  : public RegisteredImporter<Notification2030, DataTypeId::DataType_Notification2030>
{
public:
...
}; //Notification2030Importer2030

//==============================================================================

using Notification2030Importer2030
    = Importer<microvision::common::sdk::Notification2030, DataTypeId::DataType_Notification2030>;
