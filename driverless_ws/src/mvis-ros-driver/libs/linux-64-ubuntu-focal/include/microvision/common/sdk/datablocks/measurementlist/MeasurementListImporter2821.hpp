...
template<>
class Importer<MeasurementList, DataTypeId::DataType_MeasurementList2821>
  : public RegisteredImporter<MeasurementList, DataTypeId::DataType_MeasurementList2821>
{
public:
...
using MeasurementListImporter2821 = Importer<MeasurementList, DataTypeId::DataType_MeasurementList2821>;
