...
class CommandLuxResetC final : public LuxCommandC<CommandId::Id::CmdLuxReset>
{
...
public:
    ...
    constexpr static const char* const containerType{"sdk.specialcontainer.command.commandluxreset"};
