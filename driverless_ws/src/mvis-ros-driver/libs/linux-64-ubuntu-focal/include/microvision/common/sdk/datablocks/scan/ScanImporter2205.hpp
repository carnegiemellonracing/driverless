...
template<>
class Importer<Scan, DataTypeId::DataType_Scan2205> : public RegisteredImporter<Scan, DataTypeId::DataType_Scan2205>
{
public:
    //========================================
...
private:
    static constexpr const char* loggerId{"microvision::common::sdk::ScanImporter2205"};
...
using ScanImporter2205 = Importer<microvision::common::sdk::Scan, DataTypeId::DataType_Scan2205>;
