...
//==============================================================================
//! \brief This class is used to import a processed low bandwidth MOVIA scan from a binary idc data block to deserialize it into a
//! scan data container.
//------------------------------------------------------------------------------
template<>
class Importer<Scan2342, DataTypeId::DataType_Scan2342>
  : public RegisteredImporter<Scan2342, DataTypeId::DataType_Scan2342>
{
public:
    //========================================
...
private:
    ...
    //----------------------------------------
    static bool deserialize(std::istream& is, ScannerDirectionListIn2342& c);
    ...
    //!\return \c True if deserialization succeeded, otherwise: \c false
    //----------------------------------------
    static bool deserialize(std::istream& is, ScannerInfoIn2342& c);
    ...
    //!\return \c True if deserialization succeeded, otherwise: \c false
    //----------------------------------------
    static bool deserialize(std::istream& is, ScanPointIn2342& c);
    ...
    //!\return \c True if deserialization succeeded, otherwise: \c false
    //----------------------------------------
    static bool deserialize(std::istream& is, ScanPointRowIn2342& c);

}; // Scan2342Importer2342

//==============================================================================

using Scan2342Importer2342 = Importer<microvision::common::sdk::Scan2342, DataTypeId::DataType_Scan2342>;
