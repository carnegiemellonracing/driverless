...
//==============================================================================
//! \brief A log message formatter for converting the message's line number field.
//------------------------------------------------------------------------------
class LineNumberFormatter : public Formatter
{
public: // constructors, destructors
    //========================================
    //! \brief Create an instance of a formatter for the message's line number field.
    //!
    //! \param[in] modifier  The \a FormatModifier used for applying common format options.
    //! \param[in] options   A list of strings with special format options for the timestamp field (not used).
    //! \return An instance of a LineNumberFormatter.
    //----------------------------------------
    ...
    //! \brief Destructor.
    //----------------------------------------
    virtual ~LineNumberFormatter() = default;
...
private:
    LineNumberFormatter() = default;
}; // LineNumberFormatter

//==============================================================================

using LineNumberFormatterSPtr = std::shared_ptr<LineNumberFormatter>;
