...
template<>
class Importer<TimeRecord, DataTypeId::DataType_TimeRecord9000>
  : public RegisteredImporter<TimeRecord, DataTypeId::DataType_TimeRecord9000>
{
public:
...
}; //TimeRecordImporter9000

//==============================================================================

using TimeRecordImporter9000 = Importer<TimeRecord, DataTypeId::DataType_TimeRecord9000>;
