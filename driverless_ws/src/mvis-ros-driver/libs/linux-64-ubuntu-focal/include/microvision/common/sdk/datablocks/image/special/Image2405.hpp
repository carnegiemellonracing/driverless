...
#include <microvision/common/sdk/datablocks/image/special/ImageFormatIn2405.hpp>
...
//!       t2 depending on naming) are stored in image 2405.
//!
//! General data type: \ref microvision::common::sdk::Image
//------------------------------------------------------------------------------
class Image2405 : public SpecializedDataContainer
{
...
public:
    ...
    //----------------------------------------
    constexpr static const char* const containerType{"sdk.specialcontainer.image2405"};
...
public:
    ...
    //! \return This image.
    //----------------------------------------
    Image2405& operator=(const Image2405& other) = default;
...
public:
    ...
    //----------------------------------------
    void setImage(const image::ImageFormatIn2405 imageFormat,
...
public:
    ...
    //----------------------------------------
    image::ImageFormatIn2405 getFormat() const { return getImageFormatIn2405(m_imageBuffer->getImageFormat()); }
    ...
    //========================================
    //! \brief Get the timestamp of when this Image2405 has been generated.
    //! \return The timestamp of when this Image2405 has been generated.
    //----------------------------------------
    ...
    //----------------------------------------
    static image::ImageFormat getGeneralImageFormat(const image::ImageFormatIn2405 imageFormat);
    ...
    //----------------------------------------
    static image::ImageFormatIn2405 getImageFormatIn2405(const image::ImageFormat imageFormat);

public:
    //========================================
    //! \brief Set the number of elapsed microseconds since the start of the device
    //!        which created this Image2405 DataContainer.
...
private:
    ...
    //----------------------------------------
    void presetImageBuffer(const image::ImageFormatIn2405 imageFormat,
...
private:
    static constexpr const char* loggerId = "microvision::common::sdk::Image2405";
...
//------------------------------------------------------------------------------
bool operator==(const Image2405& lhs, const Image2405& rhs);
...
//------------------------------------------------------------------------------
inline bool operator!=(const Image2405& lhs, const Image2405& rhs) { return !(lhs == rhs); }
