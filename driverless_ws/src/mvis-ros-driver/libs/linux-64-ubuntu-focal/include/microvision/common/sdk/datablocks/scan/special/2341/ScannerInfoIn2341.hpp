...
#include <microvision/common/sdk/datablocks/scan/special/2341/ScannerDirectionListIn2341.hpp>
...
//------------------------------------------------------------------------------
class MICROVISION_SDK_DEPRECATED ScannerInfoIn2341 final
{
public:
    //========================================
    //! \brief Default constructor.
    //----------------------------------------
    ScannerInfoIn2341() = default;
    ...
    //----------------------------------------
    ScannerInfoIn2341(const ScannerInfoIn2341& src) = default;
    ...
    //----------------------------------------
    ScannerInfoIn2341& operator=(const ScannerInfoIn2341& src) = default;
...
public: // getter
    ...
    //----------------------------------------
    const ScannerDirectionListIn2341& getDirections() const { return m_directionList; }
...
public: // setter
    ...
    //----------------------------------------
    void setDirections(const ScannerDirectionListIn2341& directionList) { m_directionList = directionList; }
...
private:
    ...
    ScannerDirectionListIn2341 m_directionList{}; //!< The directions of each scanner pixel.
...
//------------------------------------------------------------------------------
bool operator==(const ScannerInfoIn2341& lhs, const ScannerInfoIn2341& rhs);
...
//------------------------------------------------------------------------------
inline bool operator!=(const ScannerInfoIn2341& lhs, const ScannerInfoIn2341& rhs) { return !(lhs == rhs); }
