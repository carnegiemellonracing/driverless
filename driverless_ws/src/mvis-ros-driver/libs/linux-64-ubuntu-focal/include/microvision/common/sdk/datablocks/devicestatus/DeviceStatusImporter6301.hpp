...
template<>
class Importer<DeviceStatus, DataTypeId::DataType_DeviceStatus6301>
  : public RegisteredImporter<DeviceStatus, DataTypeId::DataType_DeviceStatus6301>
{
public:
    //========================================
...
}; // DeviceStatusImporter6301

//==============================================================================

using DeviceStatusImporter6301 = Importer<DeviceStatus, DataTypeId::DataType_DeviceStatus6301>;
