...
//==============================================================================
//! \brief Deserialize a 9105 stream into a VehicleRequest data container.
//------------------------------------------------------------------------------
template<>
class Importer<VehicleRequest, DataTypeId::DataType_VehicleRequest9105>
  : public RegisteredImporter<VehicleRequest, DataTypeId::DataType_VehicleRequest9105>
{
public:
    //========================================
    //! \brief Constructor.
...
using VehicleRequestImporter9105 = Importer<VehicleRequest, DataTypeId::DataType_VehicleRequest9105>;
