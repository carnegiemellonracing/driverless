...
#include <microvision/common/sdk/datablocks/commands/luxcommands/CommandLuxSetParameterC.hpp>
...
template<>
class SpecialImporter<Command2010, DataTypeId::DataType_Command2010, CommandLuxSetParameterC>
  : public SpecialRegisteredImporter<Command2010, DataTypeId::DataType_Command2010, CommandLuxSetParameterC>
{
public:
...
public:
    SpecialImporter()
      : SpecialRegisteredImporter<Command2010, DataTypeId::DataType_Command2010, CommandLuxSetParameterC>()
    {}
...
using CommandLuxSetParameter2010Importer2010
    = SpecialImporter<Command2010, DataTypeId::DataType_Command2010, CommandLuxSetParameterC>;
