...
template<>
class SpecialImporter<Command2010, DataTypeId::DataType_Command2010, CommandEcuAppBaseStatusC>
  : public SpecialRegisteredImporter<Command2010, DataTypeId::DataType_Command2010, CommandEcuAppBaseStatusC>
{
public:
...
public:
    SpecialImporter()
      : SpecialRegisteredImporter<Command2010, DataTypeId::DataType_Command2010, CommandEcuAppBaseStatusC>()
    {}
...
using CommandEcuAppBaseStatus2010Importer2010
    = SpecialImporter<Command2010, DataTypeId::DataType_Command2010, CommandEcuAppBaseStatusC>;
