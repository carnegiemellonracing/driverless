...
template<>
class Importer<GpsImu, DataTypeId::DataType_GpsImu9004>
  : public RegisteredImporter<GpsImu, DataTypeId::DataType_GpsImu9004>
{
public:
...
using GpsImuImporter9004 = Importer<GpsImu, DataTypeId::DataType_GpsImu9004>;
