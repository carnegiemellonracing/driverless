...
//! \file
//!
//! \brief Imports object type 0x2291 from general object container
//!
...
#include <microvision/common/sdk/datablocks/objectlist/ObjectListImporter2281_2291.hpp>
...
template<>
class Importer<ObjectList, DataTypeId::DataType_ObjectList2291>
  : public RegisteredImporter<ObjectList, DataTypeId::DataType_ObjectList2291>, protected ObjectListImporter2281_2291
{
public:
...
public: // implements ImporterBase
    ...
    {
        (void)configuration;
        return ObjectListImporter2281_2291::getSerializedSize(dataContainer);
    }
    ...
    {
        (void)configuration;
        return ObjectListImporter2281_2291::deserialize(inputStream, dataContainer, dataHeader);
    }
...
using ObjectListImporter2291 = Importer<ObjectList, DataTypeId::DataType_ObjectList2291>;
