...
//------------------------------------------------------------------------------
enum class ImageFormatIn2405 : uint16_t
{
...
//!
//! \param[in] format  Image2405 format id to be converted into a string.
//! \return Name of the image format.
//------------------------------------------------------------------------------
std::string formatToString(const ImageFormatIn2405 format);
