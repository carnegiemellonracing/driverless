...
//! \file
//!
//! \brief Extension which provides UDP implementations for the network interface factory.
//!
...
//------------------------------------------------------------------------------
class UdpNetworkInterfaceFactoryExtension : public NetworkInterfaceFactoryExtension
{
public:
    //========================================
    //! \brief Default constructor.
    //----------------------------------------
    UdpNetworkInterfaceFactoryExtension();

    //========================================
    //! \brief Default destructor.
    //----------------------------------------
    ~UdpNetworkInterfaceFactoryExtension() override;
...
}; // class UdpNetworkInterfaceFactoryExtension
