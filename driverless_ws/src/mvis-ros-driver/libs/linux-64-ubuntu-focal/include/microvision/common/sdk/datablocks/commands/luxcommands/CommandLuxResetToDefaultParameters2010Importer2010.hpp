...
template<>
class SpecialImporter<Command2010, DataTypeId::DataType_Command2010, CommandLuxResetToDefaultParametersC>
  : public SpecialRegisteredImporter<Command2010, DataTypeId::DataType_Command2010, CommandLuxResetToDefaultParametersC>
{
public:
...
public:
    SpecialImporter()
      : SpecialRegisteredImporter<Command2010, DataTypeId::DataType_Command2010, CommandLuxResetToDefaultParametersC>()
    {}
...
using CommandLuxResetToDefaultParameters2010Importer2010
    = SpecialImporter<Command2010, DataTypeId::DataType_Command2010, CommandLuxResetToDefaultParametersC>;
