...
#include <microvision/common/sdk/devices/MvisLuxHr.hpp>
...
//! \extends IdcDevice
//------------------------------------------------------------------------------
class MvisLuxHrSensorDevice final : public IdcDevice, private IdcDataPackageListener
{
public:
    //========================================
    ...
    //----------------------------------------
    static constexpr MICROVISION_SDK_API uint16_t defaultTcpPort{12008};

private:
    //========================================
    //! \brief Logger name for configuration setup.
    //----------------------------------------
    static constexpr const char* m_loggerId = "microvision::common::sdk::MvisLuxHrSensorDevice";
...
public:
    ...
    //! \brief Constructor.
    //----------------------------------------
    MvisLuxHrSensorDevice();

    //========================================
    //! \brief Destructor.
    //----------------------------------------
    ~MvisLuxHrSensorDevice() override;
...
private:
    ...
    //========================================
    //! \brief Obsolete MvisLuxHr device which is wrapped in this class.
    //----------------------------------------
    std::unique_ptr<MvisLuxHr> m_delegate;

}; // class MvisLuxHrSensorDevice

//==============================================================================
//! \brief Pointer type of LUX sensor device.
//------------------------------------------------------------------------------
using MvisLuxHrSensorDevicePtr = std::unique_ptr<MvisLuxHrSensorDevice>;
