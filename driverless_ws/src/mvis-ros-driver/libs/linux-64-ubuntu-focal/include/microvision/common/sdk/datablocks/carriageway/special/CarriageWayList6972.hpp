...
//------------------------------------------------------------------------------
class CarriageWayList6972 final : public SpecializedDataContainer
{
...
public:
    constexpr static const char* const containerType{"sdk.specialcontainer.carriagewaylist6972"};
