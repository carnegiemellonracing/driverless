...
//==============================================================================
//! \brief Importer for the odometry 9003 data container.
//------------------------------------------------------------------------------
template<>
class Importer<Odometry, DataTypeId::DataType_Odometry9003>
  : public RegisteredImporter<Odometry, DataTypeId::DataType_Odometry9003>
{
public:
    //========================================
    //! \brief Constructor.
...
}; //OdometryImporter9003

//==============================================================================

using OdometryImporter9003 = Importer<Odometry, DataTypeId::DataType_Odometry9003>;
