...
//------------------------------------------------------------------------------
class MICROVISION_SDK_DEPRECATED ScannerDirectionListIn2341 final
{
public:
...
public:
    ...
    //----------------------------------------
    ScannerDirectionListIn2341() = default;
    ...
    //----------------------------------------
    ScannerDirectionListIn2341(const ScannerDirectionListIn2341& src) = default;
    ...
    //----------------------------------------
    ScannerDirectionListIn2341& operator=(const ScannerDirectionListIn2341& src) = default;
...
public:
    ...
    //----------------------------------------
    float getRadialDistanceStandardDeviationInCentimeter() const { return m_radialDistanceStdDev; }
...
public: // setter
    ...
    //----------------------------------------
    void setRadialDistanceStandardDeviationInCentimeter(const float radialDistanceStdDev)
    {
...
private:
    ...
    float m_radialDistanceStdDev{}; //!< The standard deviation of the radial distance.
    PixelDirectionArray m_directions{}; //!< The beam directions for all pixels.

}; // ScannerDirectionListIn2341
...
//------------------------------------------------------------------------------
bool operator==(const ScannerDirectionListIn2341& lhs, const ScannerDirectionListIn2341& rhs);
...
//------------------------------------------------------------------------------
inline bool operator!=(const ScannerDirectionListIn2341& lhs, const ScannerDirectionListIn2341& rhs)
{
    return !(lhs == rhs);
}
