...
template<>
class SpecialExporter<CommandMiniLuxGetParameterC> : public SpecialExporterBase<CommandCBase>
{
public:
...
public:
    ...
    //!        can handle.
    //----------------------------------------
    virtual CommandCBase::KeyType getSpecialType() const override { return CommandMiniLuxGetParameterC::key; }
...
using CommandMiniLuxGetParameter2010Exporter2010 = SpecialExporter<CommandMiniLuxGetParameterC>;
