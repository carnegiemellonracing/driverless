...
//! \brief LogMessage Importer ErrorMsg
//!
//! Special data type:
//! \ref microvision::common::sdk::LogMessageError6400
template<>
class Importer<LogMessage, DataTypeId::DataType_LogError6400>
  : public RegisteredImporter<LogMessage, DataTypeId::DataType_LogError6400>, protected LogMessageImporter<LogMessage>
{
public:
...
}; //LogMessageImporter6400

//==============================================================================

using LogMessageImporter6400 = Importer<LogMessage, DataTypeId::DataType_LogError6400>;
