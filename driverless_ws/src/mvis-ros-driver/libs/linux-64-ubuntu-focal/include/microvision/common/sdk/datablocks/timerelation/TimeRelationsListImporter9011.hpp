...
template<>
class Importer<TimeRelationsList, DataTypeId::DataType_TimeRelationsList9011>
  : public RegisteredImporter<TimeRelationsList, DataTypeId::DataType_TimeRelationsList9011>
{
public:
    //========================================
...
}; // TimeRelationsListImporter9011

//==============================================================================

using TimeRelationsListImporter9011
    = Importer<microvision::common::sdk::TimeRelationsList, DataTypeId::DataType_TimeRelationsList9011>;
