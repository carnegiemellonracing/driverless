...
//! \file
//!
//! \brief Imports vehicleState type 0x2806 to general vehicle state container
//!
...
template<>
class Importer<VehicleState, DataTypeId::DataType_VehicleStateBasic2806>
  : public RegisteredImporter<VehicleState, DataTypeId::DataType_VehicleStateBasic2806>
{
public:
...
using VehicleStateImporter2806 = Importer<VehicleState, DataTypeId::DataType_VehicleStateBasic2806>;
