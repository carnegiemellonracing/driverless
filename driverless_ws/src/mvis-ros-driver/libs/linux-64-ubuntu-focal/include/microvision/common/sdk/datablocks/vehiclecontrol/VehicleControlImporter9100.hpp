...
template<>
class Importer<VehicleControl, DataTypeId::DataType_VehicleControl9100>
  : public RegisteredImporter<VehicleControl, DataTypeId::DataType_VehicleControl9100>
{
public:
    //========================================
    //! \brief Constructor.
...
using VehicleControlImporter9100 = Importer<VehicleControl, DataTypeId::DataType_VehicleControl9100>;
