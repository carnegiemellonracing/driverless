...
template<>
class SpecialImporter<Command2010, DataTypeId::DataType_Command2010, CommandMiniLuxGetStatusC>
  : public SpecialRegisteredImporter<Command2010, DataTypeId::DataType_Command2010, CommandMiniLuxGetStatusC>
{
public:
...
public:
    SpecialImporter()
      : SpecialRegisteredImporter<Command2010, DataTypeId::DataType_Command2010, CommandMiniLuxGetStatusC>()
    {}
...
using CommandMiniLuxGetStatus2010Importer2010
    = SpecialImporter<Command2010, DataTypeId::DataType_Command2010, CommandMiniLuxGetStatusC>;
