...
//! \file
//!
//! \brief Deserialize data container PointCloud7511 from stream into
//!        general PointCloud container.
//!
...
//==============================================================================
//! \brief This class is used to import a processed point cloud tile data block to deserialize it into a
//! sdk data container.
//------------------------------------------------------------------------------
template<>
class Importer<PointCloud, DataTypeId::DataType_PointCloud7511>
  : public RegisteredImporter<PointCloud, DataTypeId::DataType_PointCloud7511>
{
public:
    //========================================
...
}; // PointCloudImporter7511

//==============================================================================

using PointCloudImporter7511 = Importer<PointCloud, DataTypeId::DataType_PointCloud7511>;
