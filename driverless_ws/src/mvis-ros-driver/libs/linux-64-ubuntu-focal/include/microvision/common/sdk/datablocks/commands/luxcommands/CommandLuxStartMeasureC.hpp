...
class CommandLuxStartMeasureC final : public LuxCommandC<CommandId::Id::CmdLuxStartMeasure>
{
...
public:
    ...
    constexpr static const char* const containerType{"sdk.specialcontainer.command2010.commandluxstartmeasure"};
