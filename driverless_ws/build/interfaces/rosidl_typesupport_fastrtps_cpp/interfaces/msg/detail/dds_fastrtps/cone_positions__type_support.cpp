...
#include "interfaces/msg/detail/cone_positions__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::ConePositions & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::ConePositions & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const interfaces::msg::ConePositions *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::ConePositions *>(
    untyped_ros_message);
...
static size_t _ConePositions__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ConePositions(full_bounded, is_plain, 0);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_ConePositions__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, ConePositions)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_ConePositions__handle;
}
