...
#include "interfaces/msg/detail/points__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::Points & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::Points & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const interfaces::msg::Points *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::Points *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_Points__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, Points)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_Points__handle;
}
