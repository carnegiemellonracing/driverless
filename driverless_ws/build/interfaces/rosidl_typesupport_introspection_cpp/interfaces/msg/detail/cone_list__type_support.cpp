...
void fetch_function__ConeList__blue_cones(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const geometry_msgs::msg::Point *>(
    get_const_function__ConeList__blue_cones(untyped_member, index));
  auto & value = *reinterpret_cast<geometry_msgs::msg::Point *>(untyped_value);
  value = item;
}

void assign_function__ConeList__blue_cones(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<geometry_msgs::msg::Point *>(
    get_function__ConeList__blue_cones(untyped_member, index));
...
void fetch_function__ConeList__yellow_cones(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const geometry_msgs::msg::Point *>(
    get_const_function__ConeList__yellow_cones(untyped_member, index));
  auto & value = *reinterpret_cast<geometry_msgs::msg::Point *>(untyped_value);
  value = item;
}

void assign_function__ConeList__yellow_cones(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<geometry_msgs::msg::Point *>(
    get_function__ConeList__yellow_cones(untyped_member, index));
  const auto & value = *reinterpret_cast<const geometry_msgs::msg::Point *>(untyped_value);
  item = value;
}
...
void fetch_function__ConeList__orange_cones(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const geometry_msgs::msg::Point *>(
    get_const_function__ConeList__orange_cones(untyped_member, index));
  auto & value = *reinterpret_cast<geometry_msgs::msg::Point *>(untyped_value);
  value = item;
}

void assign_function__ConeList__orange_cones(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<geometry_msgs::msg::Point *>(
    get_function__ConeList__orange_cones(untyped_member, index));
  const auto & value = *reinterpret_cast<const geometry_msgs::msg::Point *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ConeList_message_member_array[3] = {
  {
    ...
    fetch_function__ConeList__blue_cones,  // fetch(index, &value) function pointer
    assign_function__ConeList__blue_cones,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__ConeList__yellow_cones,  // fetch(index, &value) function pointer
    assign_function__ConeList__yellow_cones,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__ConeList__orange_cones,  // fetch(index, &value) function pointer
    assign_function__ConeList__orange_cones,  // assign(index, value) function pointer
