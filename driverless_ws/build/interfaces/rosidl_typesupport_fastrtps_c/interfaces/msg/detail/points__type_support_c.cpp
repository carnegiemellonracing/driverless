...
#include "interfaces/msg/detail/points__rosidl_typesupport_fastrtps_c.h"
...
using _Points__ros_msg_type = interfaces__msg__Points;
...
static uint32_t _Points__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__msg__Points(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, msg, Points)() {
