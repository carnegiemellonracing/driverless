...
{
  new (message_memory) eufs_msgs::msg::PointArrayStamped(_init);
}

void PointArrayStamped_fini_function(void * message_memory)
{
  auto typed_message = static_cast<eufs_msgs::msg::PointArrayStamped *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PointArrayStamped_message_member_array[2] = {
  {
    ...
    offsetof(eufs_msgs::msg::PointArrayStamped, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(eufs_msgs::msg::PointArrayStamped, points),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers PointArrayStamped_message_members = {
  ...
  2,  // number of fields
  sizeof(eufs_msgs::msg::PointArrayStamped),
...
{
  return &::eufs_msgs::msg::rosidl_typesupport_introspection_cpp::PointArrayStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, eufs_msgs, msg, PointArrayStamped)() {
  return &::eufs_msgs::msg::rosidl_typesupport_introspection_cpp::PointArrayStamped_message_type_support_handle;
}
