...
class MPCState(metaclass=Metaclass_MPCState):
    ...
    def __init__(self, **kwargs):
        ...
        self.exitflag = kwargs.get('exitflag', int())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.exitflag != other.exitflag:
            return False
    ...
    def exitflag(self, value):
        if __debug__:
            assert \
                ...
                "The 'exitflag' field must be of type 'int'"
            assert value >= -128 and value < 128, \
                "The 'exitflag' field must be an integer in [-128, 127]"
