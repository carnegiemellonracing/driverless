...
bool eufs_msgs__msg__cone_with_covariance__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("eufs_msgs.msg._cone_with_covariance.ConeWithCovariance", full_classname_dest, 54) == 0);
  }
  eufs_msgs__msg__ConeWithCovariance * ros_message = _ros_message;
  {  // point
...
PyObject * eufs_msgs__msg__cone_with_covariance__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("eufs_msgs.msg._cone_with_covariance");
