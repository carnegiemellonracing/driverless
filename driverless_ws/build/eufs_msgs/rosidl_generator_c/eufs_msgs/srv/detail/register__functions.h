...
#ifndef EUFS_MSGS__SRV__DETAIL__REGISTER__FUNCTIONS_H_
#define EUFS_MSGS__SRV__DETAIL__REGISTER__FUNCTIONS_H_
 ...
 * calls
 * eufs_msgs__srv__Register_Request__init().
...
/**
 * It calls
 * eufs_msgs__srv__Register_Request__fini()
 ...
 * eufs_msgs__srv__Register_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * eufs_msgs__srv__Register_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * eufs_msgs__srv__Register_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_eufs_msgs
...
/**
 * It calls
 * eufs_msgs__srv__Register_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_eufs_msgs
...
/**
 * It allocates the memory for the array and calls
 * eufs_msgs__srv__Register_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_eufs_msgs
...
/**
 * It calls
 * eufs_msgs__srv__Register_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // EUFS_MSGS__SRV__DETAIL__REGISTER__FUNCTIONS_H_
