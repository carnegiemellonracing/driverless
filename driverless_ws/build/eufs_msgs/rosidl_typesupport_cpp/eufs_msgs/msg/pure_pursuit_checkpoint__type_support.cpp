...
static const _PurePursuitCheckpoint_type_support_symbol_names_t _PurePursuitCheckpoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, eufs_msgs, msg, PurePursuitCheckpoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, eufs_msgs, msg, PurePursuitCheckpoint)),
  }
};
...
{
  return &::eufs_msgs::msg::rosidl_typesupport_cpp::PurePursuitCheckpoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, eufs_msgs, msg, PurePursuitCheckpoint)() {
  return get_message_type_support_handle<eufs_msgs::msg::PurePursuitCheckpoint>();
}
