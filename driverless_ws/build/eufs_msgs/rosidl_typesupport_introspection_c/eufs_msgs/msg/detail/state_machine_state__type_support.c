...
#include <stddef.h>
#include "eufs_msgs/msg/detail/state_machine_state__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember StateMachineState__rosidl_typesupport_introspection_c__StateMachineState_message_member_array[2] = {
  {
    ...
    offsetof(eufs_msgs__msg__StateMachineState, state),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(eufs_msgs__msg__StateMachineState, state_str),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers StateMachineState__rosidl_typesupport_introspection_c__StateMachineState_message_members = {
  ...
  2,  // number of fields
  sizeof(eufs_msgs__msg__StateMachineState),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, eufs_msgs, msg, StateMachineState)() {
