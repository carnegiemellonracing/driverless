...
{
  eufs_msgs__msg__CanState * msg = (eufs_msgs__msg__CanState *)malloc(sizeof(eufs_msgs__msg__CanState));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__CanState__Sequence__init(eufs_msgs__msg__CanState__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__CanState *)calloc(size, sizeof(eufs_msgs__msg__CanState));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__CanState__Sequence * array = (eufs_msgs__msg__CanState__Sequence *)malloc(sizeof(eufs_msgs__msg__CanState__Sequence));
  if (!array) {
    return NULL;
  }
