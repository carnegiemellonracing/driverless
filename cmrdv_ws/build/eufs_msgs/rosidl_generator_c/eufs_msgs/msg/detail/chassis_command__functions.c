...
{
  eufs_msgs__msg__ChassisCommand * msg = (eufs_msgs__msg__ChassisCommand *)malloc(sizeof(eufs_msgs__msg__ChassisCommand));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__ChassisCommand__Sequence__init(eufs_msgs__msg__ChassisCommand__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__ChassisCommand *)calloc(size, sizeof(eufs_msgs__msg__ChassisCommand));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__ChassisCommand__Sequence * array = (eufs_msgs__msg__ChassisCommand__Sequence *)malloc(sizeof(eufs_msgs__msg__ChassisCommand__Sequence));
  if (!array) {
    return NULL;
  }
