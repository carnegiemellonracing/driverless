...
{
  eufs_msgs__msg__LapStats * msg = (eufs_msgs__msg__LapStats *)malloc(sizeof(eufs_msgs__msg__LapStats));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__LapStats__Sequence__init(eufs_msgs__msg__LapStats__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__LapStats *)calloc(size, sizeof(eufs_msgs__msg__LapStats));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__LapStats__Sequence * array = (eufs_msgs__msg__LapStats__Sequence *)malloc(sizeof(eufs_msgs__msg__LapStats__Sequence));
  if (!array) {
    return NULL;
  }
