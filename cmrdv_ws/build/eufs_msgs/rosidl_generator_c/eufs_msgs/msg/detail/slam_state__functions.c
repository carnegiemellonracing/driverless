...
{
  eufs_msgs__msg__SLAMState * msg = (eufs_msgs__msg__SLAMState *)malloc(sizeof(eufs_msgs__msg__SLAMState));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__SLAMState__Sequence__init(eufs_msgs__msg__SLAMState__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__SLAMState *)calloc(size, sizeof(eufs_msgs__msg__SLAMState));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__SLAMState__Sequence * array = (eufs_msgs__msg__SLAMState__Sequence *)malloc(sizeof(eufs_msgs__msg__SLAMState__Sequence));
  if (!array) {
    return NULL;
  }
