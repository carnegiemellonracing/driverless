...
{
  eufs_msgs__msg__WaypointArrayStamped * msg = (eufs_msgs__msg__WaypointArrayStamped *)malloc(sizeof(eufs_msgs__msg__WaypointArrayStamped));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__WaypointArrayStamped__Sequence__init(eufs_msgs__msg__WaypointArrayStamped__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__WaypointArrayStamped *)calloc(size, sizeof(eufs_msgs__msg__WaypointArrayStamped));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__WaypointArrayStamped__Sequence * array = (eufs_msgs__msg__WaypointArrayStamped__Sequence *)malloc(sizeof(eufs_msgs__msg__WaypointArrayStamped__Sequence));
  if (!array) {
    return NULL;
  }
