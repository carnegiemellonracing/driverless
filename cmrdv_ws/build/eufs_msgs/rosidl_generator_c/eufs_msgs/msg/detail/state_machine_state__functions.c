...
{
  eufs_msgs__msg__StateMachineState * msg = (eufs_msgs__msg__StateMachineState *)malloc(sizeof(eufs_msgs__msg__StateMachineState));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__StateMachineState__Sequence__init(eufs_msgs__msg__StateMachineState__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__StateMachineState *)calloc(size, sizeof(eufs_msgs__msg__StateMachineState));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__StateMachineState__Sequence * array = (eufs_msgs__msg__StateMachineState__Sequence *)malloc(sizeof(eufs_msgs__msg__StateMachineState__Sequence));
  if (!array) {
    return NULL;
  }
