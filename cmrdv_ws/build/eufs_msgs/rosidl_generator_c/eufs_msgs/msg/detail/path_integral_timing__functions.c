...
{
  eufs_msgs__msg__PathIntegralTiming * msg = (eufs_msgs__msg__PathIntegralTiming *)malloc(sizeof(eufs_msgs__msg__PathIntegralTiming));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__PathIntegralTiming__Sequence__init(eufs_msgs__msg__PathIntegralTiming__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__PathIntegralTiming *)calloc(size, sizeof(eufs_msgs__msg__PathIntegralTiming));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__PathIntegralTiming__Sequence * array = (eufs_msgs__msg__PathIntegralTiming__Sequence *)malloc(sizeof(eufs_msgs__msg__PathIntegralTiming__Sequence));
  if (!array) {
    return NULL;
  }
