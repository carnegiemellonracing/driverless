...
{
  eufs_msgs__msg__TopicStatus * msg = (eufs_msgs__msg__TopicStatus *)malloc(sizeof(eufs_msgs__msg__TopicStatus));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__TopicStatus__Sequence__init(eufs_msgs__msg__TopicStatus__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__TopicStatus *)calloc(size, sizeof(eufs_msgs__msg__TopicStatus));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__TopicStatus__Sequence * array = (eufs_msgs__msg__TopicStatus__Sequence *)malloc(sizeof(eufs_msgs__msg__TopicStatus__Sequence));
  if (!array) {
    return NULL;
  }
