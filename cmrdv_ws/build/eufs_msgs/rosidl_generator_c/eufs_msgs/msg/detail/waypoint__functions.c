...
{
  eufs_msgs__msg__Waypoint * msg = (eufs_msgs__msg__Waypoint *)malloc(sizeof(eufs_msgs__msg__Waypoint));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__Waypoint__Sequence__init(eufs_msgs__msg__Waypoint__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__Waypoint *)calloc(size, sizeof(eufs_msgs__msg__Waypoint));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__Waypoint__Sequence * array = (eufs_msgs__msg__Waypoint__Sequence *)malloc(sizeof(eufs_msgs__msg__Waypoint__Sequence));
  if (!array) {
    return NULL;
  }
