...
{
  eufs_msgs__msg__SLAMErr * msg = (eufs_msgs__msg__SLAMErr *)malloc(sizeof(eufs_msgs__msg__SLAMErr));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__SLAMErr__Sequence__init(eufs_msgs__msg__SLAMErr__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__SLAMErr *)calloc(size, sizeof(eufs_msgs__msg__SLAMErr));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__SLAMErr__Sequence * array = (eufs_msgs__msg__SLAMErr__Sequence *)malloc(sizeof(eufs_msgs__msg__SLAMErr__Sequence));
  if (!array) {
    return NULL;
  }
