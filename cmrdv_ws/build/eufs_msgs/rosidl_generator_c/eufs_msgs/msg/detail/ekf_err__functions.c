...
{
  eufs_msgs__msg__EKFErr * msg = (eufs_msgs__msg__EKFErr *)malloc(sizeof(eufs_msgs__msg__EKFErr));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__EKFErr__Sequence__init(eufs_msgs__msg__EKFErr__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__EKFErr *)calloc(size, sizeof(eufs_msgs__msg__EKFErr));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__EKFErr__Sequence * array = (eufs_msgs__msg__EKFErr__Sequence *)malloc(sizeof(eufs_msgs__msg__EKFErr__Sequence));
  if (!array) {
    return NULL;
  }
