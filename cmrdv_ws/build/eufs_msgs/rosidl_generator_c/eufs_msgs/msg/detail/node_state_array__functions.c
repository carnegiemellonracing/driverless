...
{
  eufs_msgs__msg__NodeStateArray * msg = (eufs_msgs__msg__NodeStateArray *)malloc(sizeof(eufs_msgs__msg__NodeStateArray));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__NodeStateArray__Sequence__init(eufs_msgs__msg__NodeStateArray__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__NodeStateArray *)calloc(size, sizeof(eufs_msgs__msg__NodeStateArray));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__NodeStateArray__Sequence * array = (eufs_msgs__msg__NodeStateArray__Sequence *)malloc(sizeof(eufs_msgs__msg__NodeStateArray__Sequence));
  if (!array) {
    return NULL;
  }
