...
{
  eufs_msgs__msg__MPCState * msg = (eufs_msgs__msg__MPCState *)malloc(sizeof(eufs_msgs__msg__MPCState));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__MPCState__Sequence__init(eufs_msgs__msg__MPCState__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__MPCState *)calloc(size, sizeof(eufs_msgs__msg__MPCState));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__MPCState__Sequence * array = (eufs_msgs__msg__MPCState__Sequence *)malloc(sizeof(eufs_msgs__msg__MPCState__Sequence));
  if (!array) {
    return NULL;
  }
