...
{
  eufs_msgs__msg__Runstop * msg = (eufs_msgs__msg__Runstop *)malloc(sizeof(eufs_msgs__msg__Runstop));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__Runstop__Sequence__init(eufs_msgs__msg__Runstop__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__Runstop *)calloc(size, sizeof(eufs_msgs__msg__Runstop));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__Runstop__Sequence * array = (eufs_msgs__msg__Runstop__Sequence *)malloc(sizeof(eufs_msgs__msg__Runstop__Sequence));
  if (!array) {
    return NULL;
  }
