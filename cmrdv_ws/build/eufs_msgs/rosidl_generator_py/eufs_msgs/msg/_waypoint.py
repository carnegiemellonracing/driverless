...
class Waypoint(metaclass=Metaclass_Waypoint):
    ...
    def __init__(self, **kwargs):
        ...
        self.suggested_steering = kwargs.get('suggested_steering', float())
    ...
    def __eq__(self, other):
        ...
        if self.speed != other.speed:
            return False
        if self.suggested_steering != other.suggested_steering:
            return False
        return True
    ...
    @property
    def suggested_steering(self):
        """Message field 'suggested_steering'."""
        return self._suggested_steering

    @suggested_steering.setter
    def suggested_steering(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'suggested_steering' field must be of type 'float'"
        self._suggested_steering = value
