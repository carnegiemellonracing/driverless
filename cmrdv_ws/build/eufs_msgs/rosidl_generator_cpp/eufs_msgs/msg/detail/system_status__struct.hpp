...
struct SystemStatus_
{
  ...
  using _topic_statuses_type =
    std::vector<eufs_msgs::msg::TopicStatus_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<eufs_msgs::msg::TopicStatus_<ContainerAllocator>>>;
  ...
  Type & set__topic_statuses(
    const std::vector<eufs_msgs::msg::TopicStatus_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<eufs_msgs::msg::TopicStatus_<ContainerAllocator>>> & _arg)
  {
