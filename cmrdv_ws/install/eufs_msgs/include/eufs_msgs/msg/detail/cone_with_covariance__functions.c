...
{
  eufs_msgs__msg__ConeWithCovariance * msg = (eufs_msgs__msg__ConeWithCovariance *)malloc(sizeof(eufs_msgs__msg__ConeWithCovariance));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__ConeWithCovariance__Sequence__init(eufs_msgs__msg__ConeWithCovariance__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__ConeWithCovariance *)calloc(size, sizeof(eufs_msgs__msg__ConeWithCovariance));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__ConeWithCovariance__Sequence * array = (eufs_msgs__msg__ConeWithCovariance__Sequence *)malloc(sizeof(eufs_msgs__msg__ConeWithCovariance__Sequence));
  if (!array) {
    return NULL;
  }
