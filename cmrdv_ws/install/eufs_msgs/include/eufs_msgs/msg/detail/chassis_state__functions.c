...
{
  eufs_msgs__msg__ChassisState * msg = (eufs_msgs__msg__ChassisState *)malloc(sizeof(eufs_msgs__msg__ChassisState));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__ChassisState__Sequence__init(eufs_msgs__msg__ChassisState__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__ChassisState *)calloc(size, sizeof(eufs_msgs__msg__ChassisState));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__ChassisState__Sequence * array = (eufs_msgs__msg__ChassisState__Sequence *)malloc(sizeof(eufs_msgs__msg__ChassisState__Sequence));
  if (!array) {
    return NULL;
  }
