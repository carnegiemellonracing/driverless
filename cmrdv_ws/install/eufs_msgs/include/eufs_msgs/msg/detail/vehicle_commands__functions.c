...
{
  eufs_msgs__msg__VehicleCommands * msg = (eufs_msgs__msg__VehicleCommands *)malloc(sizeof(eufs_msgs__msg__VehicleCommands));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__VehicleCommands__Sequence__init(eufs_msgs__msg__VehicleCommands__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__VehicleCommands *)calloc(size, sizeof(eufs_msgs__msg__VehicleCommands));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__VehicleCommands__Sequence * array = (eufs_msgs__msg__VehicleCommands__Sequence *)malloc(sizeof(eufs_msgs__msg__VehicleCommands__Sequence));
  if (!array) {
    return NULL;
  }
