...
struct WaypointArrayStamped_
{
  ...
  using _waypoints_type =
    std::vector<eufs_msgs::msg::Waypoint_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<eufs_msgs::msg::Waypoint_<ContainerAllocator>>>;
  ...
  Type & set__waypoints(
    const std::vector<eufs_msgs::msg::Waypoint_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<eufs_msgs::msg::Waypoint_<ContainerAllocator>>> & _arg)
  {
    this->waypoints = _arg;
    return *this;
  }
