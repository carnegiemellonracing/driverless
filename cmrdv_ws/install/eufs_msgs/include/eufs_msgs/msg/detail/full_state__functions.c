...
{
  eufs_msgs__msg__FullState * msg = (eufs_msgs__msg__FullState *)malloc(sizeof(eufs_msgs__msg__FullState));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__FullState__Sequence__init(eufs_msgs__msg__FullState__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__FullState *)calloc(size, sizeof(eufs_msgs__msg__FullState));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__FullState__Sequence * array = (eufs_msgs__msg__FullState__Sequence *)malloc(sizeof(eufs_msgs__msg__FullState__Sequence));
  if (!array) {
    return NULL;
  }
