...
struct PurePursuitCheckpointArrayStamped_
{
  ...
  using _checkpoints_type =
    std::vector<eufs_msgs::msg::PurePursuitCheckpoint_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<eufs_msgs::msg::PurePursuitCheckpoint_<ContainerAllocator>>>;
  ...
  Type & set__checkpoints(
    const std::vector<eufs_msgs::msg::PurePursuitCheckpoint_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<eufs_msgs::msg::PurePursuitCheckpoint_<ContainerAllocator>>> & _arg)
  {
