...
{
  eufs_msgs__msg__PathIntegralParams * msg = (eufs_msgs__msg__PathIntegralParams *)malloc(sizeof(eufs_msgs__msg__PathIntegralParams));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__PathIntegralParams__Sequence__init(eufs_msgs__msg__PathIntegralParams__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__PathIntegralParams *)calloc(size, sizeof(eufs_msgs__msg__PathIntegralParams));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__PathIntegralParams__Sequence * array = (eufs_msgs__msg__PathIntegralParams__Sequence *)malloc(sizeof(eufs_msgs__msg__PathIntegralParams__Sequence));
  if (!array) {
    return NULL;
  }
