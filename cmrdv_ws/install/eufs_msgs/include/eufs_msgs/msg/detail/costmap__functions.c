...
{
  eufs_msgs__msg__Costmap * msg = (eufs_msgs__msg__Costmap *)malloc(sizeof(eufs_msgs__msg__Costmap));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__Costmap__Sequence__init(eufs_msgs__msg__Costmap__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__Costmap *)calloc(size, sizeof(eufs_msgs__msg__Costmap));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__Costmap__Sequence * array = (eufs_msgs__msg__Costmap__Sequence *)malloc(sizeof(eufs_msgs__msg__Costmap__Sequence));
  if (!array) {
    return NULL;
  }
