...
{
  eufs_msgs__msg__WheelOdometryErr * msg = (eufs_msgs__msg__WheelOdometryErr *)malloc(sizeof(eufs_msgs__msg__WheelOdometryErr));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__WheelOdometryErr__Sequence__init(eufs_msgs__msg__WheelOdometryErr__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__WheelOdometryErr *)calloc(size, sizeof(eufs_msgs__msg__WheelOdometryErr));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__WheelOdometryErr__Sequence * array = (eufs_msgs__msg__WheelOdometryErr__Sequence *)malloc(sizeof(eufs_msgs__msg__WheelOdometryErr__Sequence));
  if (!array) {
    return NULL;
  }
