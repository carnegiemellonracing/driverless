...
struct BoundingBoxes_
{
  ...
  using _bounding_boxes_type =
    std::vector<eufs_msgs::msg::BoundingBox_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<eufs_msgs::msg::BoundingBox_<ContainerAllocator>>>;
  ...
  Type & set__bounding_boxes(
    const std::vector<eufs_msgs::msg::BoundingBox_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<eufs_msgs::msg::BoundingBox_<ContainerAllocator>>> & _arg)
  {
