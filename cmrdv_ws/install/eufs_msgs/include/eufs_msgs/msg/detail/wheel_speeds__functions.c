...
{
  eufs_msgs__msg__WheelSpeeds * msg = (eufs_msgs__msg__WheelSpeeds *)malloc(sizeof(eufs_msgs__msg__WheelSpeeds));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__WheelSpeeds__Sequence__init(eufs_msgs__msg__WheelSpeeds__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__WheelSpeeds *)calloc(size, sizeof(eufs_msgs__msg__WheelSpeeds));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__WheelSpeeds__Sequence * array = (eufs_msgs__msg__WheelSpeeds__Sequence *)malloc(sizeof(eufs_msgs__msg__WheelSpeeds__Sequence));
  if (!array) {
    return NULL;
  }
