...
{
  eufs_msgs__msg__BoundingBox * msg = (eufs_msgs__msg__BoundingBox *)malloc(sizeof(eufs_msgs__msg__BoundingBox));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__BoundingBox__Sequence__init(eufs_msgs__msg__BoundingBox__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__BoundingBox *)calloc(size, sizeof(eufs_msgs__msg__BoundingBox));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__BoundingBox__Sequence * array = (eufs_msgs__msg__BoundingBox__Sequence *)malloc(sizeof(eufs_msgs__msg__BoundingBox__Sequence));
  if (!array) {
    return NULL;
  }
