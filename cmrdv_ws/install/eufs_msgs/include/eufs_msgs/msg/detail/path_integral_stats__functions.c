...
{
  eufs_msgs__msg__PathIntegralStats * msg = (eufs_msgs__msg__PathIntegralStats *)malloc(sizeof(eufs_msgs__msg__PathIntegralStats));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__PathIntegralStats__Sequence__init(eufs_msgs__msg__PathIntegralStats__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__PathIntegralStats *)calloc(size, sizeof(eufs_msgs__msg__PathIntegralStats));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__PathIntegralStats__Sequence * array = (eufs_msgs__msg__PathIntegralStats__Sequence *)malloc(sizeof(eufs_msgs__msg__PathIntegralStats__Sequence));
  if (!array) {
    return NULL;
  }
