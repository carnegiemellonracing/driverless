...
{
  eufs_msgs__msg__PurePursuitCheckpointArrayStamped * msg = (eufs_msgs__msg__PurePursuitCheckpointArrayStamped *)malloc(sizeof(eufs_msgs__msg__PurePursuitCheckpointArrayStamped));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__PurePursuitCheckpointArrayStamped__Sequence__init(eufs_msgs__msg__PurePursuitCheckpointArrayStamped__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__PurePursuitCheckpointArrayStamped *)calloc(size, sizeof(eufs_msgs__msg__PurePursuitCheckpointArrayStamped));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__PurePursuitCheckpointArrayStamped__Sequence * array = (eufs_msgs__msg__PurePursuitCheckpointArrayStamped__Sequence *)malloc(sizeof(eufs_msgs__msg__PurePursuitCheckpointArrayStamped__Sequence));
  if (!array) {
    return NULL;
  }
