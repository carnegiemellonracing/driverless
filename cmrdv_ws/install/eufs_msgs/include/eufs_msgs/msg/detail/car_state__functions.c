...
{
  eufs_msgs__msg__CarState * msg = (eufs_msgs__msg__CarState *)malloc(sizeof(eufs_msgs__msg__CarState));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__CarState__Sequence__init(eufs_msgs__msg__CarState__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__CarState *)calloc(size, sizeof(eufs_msgs__msg__CarState));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__CarState__Sequence * array = (eufs_msgs__msg__CarState__Sequence *)malloc(sizeof(eufs_msgs__msg__CarState__Sequence));
  if (!array) {
    return NULL;
  }
