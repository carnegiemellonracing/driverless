...
{
  eufs_msgs__msg__BoundingBoxes * msg = (eufs_msgs__msg__BoundingBoxes *)malloc(sizeof(eufs_msgs__msg__BoundingBoxes));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__BoundingBoxes__Sequence__init(eufs_msgs__msg__BoundingBoxes__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__BoundingBoxes *)calloc(size, sizeof(eufs_msgs__msg__BoundingBoxes));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__BoundingBoxes__Sequence * array = (eufs_msgs__msg__BoundingBoxes__Sequence *)malloc(sizeof(eufs_msgs__msg__BoundingBoxes__Sequence));
  if (!array) {
    return NULL;
  }
