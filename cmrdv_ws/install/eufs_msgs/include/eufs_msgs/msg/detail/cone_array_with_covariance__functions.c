...
{
  eufs_msgs__msg__ConeArrayWithCovariance * msg = (eufs_msgs__msg__ConeArrayWithCovariance *)malloc(sizeof(eufs_msgs__msg__ConeArrayWithCovariance));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__ConeArrayWithCovariance__Sequence__init(eufs_msgs__msg__ConeArrayWithCovariance__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__ConeArrayWithCovariance *)calloc(size, sizeof(eufs_msgs__msg__ConeArrayWithCovariance));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__ConeArrayWithCovariance__Sequence * array = (eufs_msgs__msg__ConeArrayWithCovariance__Sequence *)malloc(sizeof(eufs_msgs__msg__ConeArrayWithCovariance__Sequence));
  if (!array) {
    return NULL;
  }
