...
{
  eufs_msgs__msg__IntegrationErr * msg = (eufs_msgs__msg__IntegrationErr *)malloc(sizeof(eufs_msgs__msg__IntegrationErr));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__IntegrationErr__Sequence__init(eufs_msgs__msg__IntegrationErr__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__IntegrationErr *)calloc(size, sizeof(eufs_msgs__msg__IntegrationErr));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__IntegrationErr__Sequence * array = (eufs_msgs__msg__IntegrationErr__Sequence *)malloc(sizeof(eufs_msgs__msg__IntegrationErr__Sequence));
  if (!array) {
    return NULL;
  }
