...
{
  eufs_msgs__msg__ConeArray * msg = (eufs_msgs__msg__ConeArray *)malloc(sizeof(eufs_msgs__msg__ConeArray));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__ConeArray__Sequence__init(eufs_msgs__msg__ConeArray__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__ConeArray *)calloc(size, sizeof(eufs_msgs__msg__ConeArray));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__ConeArray__Sequence * array = (eufs_msgs__msg__ConeArray__Sequence *)malloc(sizeof(eufs_msgs__msg__ConeArray__Sequence));
  if (!array) {
    return NULL;
  }
