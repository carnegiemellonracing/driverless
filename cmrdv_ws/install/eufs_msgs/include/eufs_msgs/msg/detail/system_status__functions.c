...
{
  eufs_msgs__msg__SystemStatus * msg = (eufs_msgs__msg__SystemStatus *)malloc(sizeof(eufs_msgs__msg__SystemStatus));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__SystemStatus__Sequence__init(eufs_msgs__msg__SystemStatus__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__SystemStatus *)calloc(size, sizeof(eufs_msgs__msg__SystemStatus));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__SystemStatus__Sequence * array = (eufs_msgs__msg__SystemStatus__Sequence *)malloc(sizeof(eufs_msgs__msg__SystemStatus__Sequence));
  if (!array) {
    return NULL;
  }
