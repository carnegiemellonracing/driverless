...
{
  eufs_msgs__msg__PathIntegralStatus * msg = (eufs_msgs__msg__PathIntegralStatus *)malloc(sizeof(eufs_msgs__msg__PathIntegralStatus));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__PathIntegralStatus__Sequence__init(eufs_msgs__msg__PathIntegralStatus__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__PathIntegralStatus *)calloc(size, sizeof(eufs_msgs__msg__PathIntegralStatus));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__PathIntegralStatus__Sequence * array = (eufs_msgs__msg__PathIntegralStatus__Sequence *)malloc(sizeof(eufs_msgs__msg__PathIntegralStatus__Sequence));
  if (!array) {
    return NULL;
  }
