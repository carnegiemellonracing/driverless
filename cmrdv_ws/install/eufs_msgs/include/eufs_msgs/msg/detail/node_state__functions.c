...
{
  eufs_msgs__msg__NodeState * msg = (eufs_msgs__msg__NodeState *)malloc(sizeof(eufs_msgs__msg__NodeState));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__msg__NodeState__Sequence__init(eufs_msgs__msg__NodeState__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__msg__NodeState *)calloc(size, sizeof(eufs_msgs__msg__NodeState));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__msg__NodeState__Sequence * array = (eufs_msgs__msg__NodeState__Sequence *)malloc(sizeof(eufs_msgs__msg__NodeState__Sequence));
  if (!array) {
    return NULL;
  }
