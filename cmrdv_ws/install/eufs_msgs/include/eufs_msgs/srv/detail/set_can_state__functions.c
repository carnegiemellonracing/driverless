...
{
  eufs_msgs__srv__SetCanState_Request * msg = (eufs_msgs__srv__SetCanState_Request *)malloc(sizeof(eufs_msgs__srv__SetCanState_Request));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__srv__SetCanState_Request__Sequence__init(eufs_msgs__srv__SetCanState_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__srv__SetCanState_Request *)calloc(size, sizeof(eufs_msgs__srv__SetCanState_Request));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__srv__SetCanState_Request__Sequence * array = (eufs_msgs__srv__SetCanState_Request__Sequence *)malloc(sizeof(eufs_msgs__srv__SetCanState_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  eufs_msgs__srv__SetCanState_Response * msg = (eufs_msgs__srv__SetCanState_Response *)malloc(sizeof(eufs_msgs__srv__SetCanState_Response));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__srv__SetCanState_Response__Sequence__init(eufs_msgs__srv__SetCanState_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__srv__SetCanState_Response *)calloc(size, sizeof(eufs_msgs__srv__SetCanState_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  eufs_msgs__srv__SetCanState_Response__Sequence * array = (eufs_msgs__srv__SetCanState_Response__Sequence *)malloc(sizeof(eufs_msgs__srv__SetCanState_Response__Sequence));
  if (!array) {
    return NULL;
  }
