...
{
  eufs_msgs__srv__Register_Request * msg = (eufs_msgs__srv__Register_Request *)malloc(sizeof(eufs_msgs__srv__Register_Request));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__srv__Register_Request__Sequence__init(eufs_msgs__srv__Register_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__srv__Register_Request *)calloc(size, sizeof(eufs_msgs__srv__Register_Request));
    if (!data) {
      return false;
    }
...
{
  eufs_msgs__srv__Register_Request__Sequence * array = (eufs_msgs__srv__Register_Request__Sequence *)malloc(sizeof(eufs_msgs__srv__Register_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  eufs_msgs__srv__Register_Response * msg = (eufs_msgs__srv__Register_Response *)malloc(sizeof(eufs_msgs__srv__Register_Response));
  if (!msg) {
    return NULL;
  }
...
eufs_msgs__srv__Register_Response__Sequence__init(eufs_msgs__srv__Register_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (eufs_msgs__srv__Register_Response *)calloc(size, sizeof(eufs_msgs__srv__Register_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  eufs_msgs__srv__Register_Response__Sequence * array = (eufs_msgs__srv__Register_Response__Sequence *)malloc(sizeof(eufs_msgs__srv__Register_Response__Sequence));
  if (!array) {
    return NULL;
  }
