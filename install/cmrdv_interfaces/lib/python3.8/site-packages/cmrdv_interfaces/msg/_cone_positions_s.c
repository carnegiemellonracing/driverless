...
bool cmrdv_interfaces__msg__cone_positions__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cmrdv_interfaces.msg._cone_positions.ConePositions", full_classname_dest, 50) == 0);
  }
  cmrdv_interfaces__msg__ConePositions * ros_message = _ros_message;
  {  // header
...
PyObject * cmrdv_interfaces__msg__cone_positions__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("cmrdv_interfaces.msg._cone_positions");
