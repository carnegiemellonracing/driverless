...
bool cmrdv_interfaces__msg__data_frame__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cmrdv_interfaces.msg._data_frame.DataFrame", full_classname_dest, 42) == 0);
  }
  cmrdv_interfaces__msg__DataFrame * ros_message = _ros_message;
  {  // zed_left_img
  ...
  {  // sbg
    PyObject * field = PyObject_GetAttrString(_pymsg, "sbg");
    if (!field) {
      return false;
    }
    if (!sbg_driver__msg__sbg_gps_pos__convert_from_py(field, &ros_message->sbg)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // imu
    ...
    if (!sbg_driver__msg__sbg_imu_data__convert_from_py(field, &ros_message->imu)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * cmrdv_interfaces__msg__data_frame__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("cmrdv_interfaces.msg._data_frame");
  ...
  {  // sbg
    PyObject * field = NULL;
    field = sbg_driver__msg__sbg_gps_pos__convert_to_py(&ros_message->sbg);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "sbg", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // imu
    PyObject * field = NULL;
    field = sbg_driver__msg__sbg_imu_data__convert_to_py(&ros_message->imu);
    if (!field) {
      return NULL;
    }
    {
