...
bool cmrdv_interfaces__msg__points__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cmrdv_interfaces.msg._points.Points", full_classname_dest, 35) == 0);
  }
  cmrdv_interfaces__msg__Points * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of Points */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("cmrdv_interfaces.msg._points");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Points");
