...
class Metaclass_PairROT(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from cmrdv_interfaces.msg import CarROT
...
class PairROT(metaclass=Metaclass_PairROT):
    ...
    _fields_and_field_types = {
        ...
        'near': 'cmrdv_interfaces/CarROT',
        'far': 'cmrdv_interfaces/CarROT',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['cmrdv_interfaces', 'msg'], 'CarROT'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['cmrdv_interfaces', 'msg'], 'CarROT'),  # noqa: E501
    )
