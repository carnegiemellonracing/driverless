...
{
  new (message_memory) cmrdv_interfaces::msg::Points(_init);
}

void Points_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cmrdv_interfaces::msg::Points *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Points_message_member_array[2] = {
  {
    ...
    offsetof(cmrdv_interfaces::msg::Points, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cmrdv_interfaces::msg::Points, points),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Points_message_members = {
  ...
  "Points",  // message name
  2,  // number of fields
  sizeof(cmrdv_interfaces::msg::Points),
...
get_message_type_support_handle<cmrdv_interfaces::msg::Points>()
{
  return &::cmrdv_interfaces::msg::rosidl_typesupport_introspection_cpp::Points_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cmrdv_interfaces, msg, Points)() {
  return &::cmrdv_interfaces::msg::rosidl_typesupport_introspection_cpp::Points_message_type_support_handle;
}
