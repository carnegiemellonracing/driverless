  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  cmrdv_interfaces__msg__CarROT__init(message_memory);
}

void CarROT__rosidl_typesupport_introspection_c__CarROT_fini_function(void * message_memory)
{
  cmrdv_interfaces__msg__CarROT__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember CarROT__rosidl_typesupport_introspection_c__CarROT_message_member_array[5] = {
  {
    ...
    offsetof(cmrdv_interfaces__msg__CarROT, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cmrdv_interfaces__msg__CarROT, x),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cmrdv_interfaces__msg__CarROT, y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cmrdv_interfaces__msg__CarROT, yaw),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cmrdv_interfaces__msg__CarROT, curvature),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers CarROT__rosidl_typesupport_introspection_c__CarROT_message_members = {
  ...
  "CarROT",  // message name
  5,  // number of fields
  sizeof(cmrdv_interfaces__msg__CarROT),
