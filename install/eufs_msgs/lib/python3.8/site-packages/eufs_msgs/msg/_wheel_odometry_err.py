...
class Metaclass_WheelOdometryErr(type):
    """Metaclass of message 'WheelOdometryErr'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'eufs_msgs.msg.WheelOdometryErr')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__wheel_odometry_err
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__wheel_odometry_err
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__wheel_odometry_err
            cls._TYPE_SUPPORT = module.type_support_msg__msg__wheel_odometry_err
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__wheel_odometry_err
...
class WheelOdometryErr(metaclass=Metaclass_WheelOdometryErr):
    """Message class 'WheelOdometryErr'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.forward_vel_err = kwargs.get('forward_vel_err', float())
    ...
    def __eq__(self, other):
        ...
        if self.angular_vel_err != other.angular_vel_err:
            return False
        if self.forward_vel_err != other.forward_vel_err:
            return False
        return True
    ...
    @property
    def forward_vel_err(self):
        """Message field 'forward_vel_err'."""
        return self._forward_vel_err

    @forward_vel_err.setter
    def forward_vel_err(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'forward_vel_err' field must be of type 'float'"
        self._forward_vel_err = value
